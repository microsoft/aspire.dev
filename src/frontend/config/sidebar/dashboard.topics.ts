  ...
  items: [
    {
      ...
      items: [
        ...
        {
          label: 'Terminal experiences',
          translations: {
            da: 'Terminaloplevelser',
            de: 'Terminalfunktionen',
            en: 'Terminal experiences',
            es: 'Experiencias de terminal',
            fr: 'Expériences de terminal',
            hi: 'टर्मिनल अनुभव',
            id: 'Pengalaman terminal',
            it: 'Esperienze terminale',
            ja: 'ターミナルの操作',
            ko: '터미널 환경',
            'pt-BR': 'Experiências de terminal',
            ru: 'Работа с терминалами',
            tr: 'Terminal deneyimleri',
            uk: 'Робота з терміналами',
            'zh-CN': '终端体验',
          },
