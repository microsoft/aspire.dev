  ...
  items: [
    ...
    },
    {
      ...
      translations: {
        ...
        en: 'Terminal features',
        es: 'Funciones de terminal',
        fr: 'Fonctionnalités du terminal',
        hi: 'टर्मिनल सुविधाएँ',
        id: 'Fitur terminal',
        it: 'Funzionalità del terminale',
        ja: 'ターミナル機能',
        ko: '터미널 기능',
        'pt-BR': 'Recursos de terminal',
        ru: 'Возможности терминала',
        tr: 'Terminal özellikleri',
        uk: 'Можливості термінала',
        'zh-CN': '终端功能',
      },
      items: [
        {
          ...
          slug: 'dashboard/terminals',
        },
        {
          label: 'Resource terminals',
          translations: {
            da: 'Ressourceterminaler',
            de: 'Ressourcenterminals',
            en: 'Resource terminals',
            es: 'Terminales de recursos',
            fr: 'Terminaux de ressources',
            hi: 'संसाधन टर्मिनल',
            id: 'Terminal sumber daya',
            it: 'Terminali delle risorse',
            ja: 'リソースターミナル',
            ko: '리소스 터미널',
            'pt-BR': 'Terminais de recursos',
            ru: 'Терминалы ресурсов',
            tr: 'Kaynak terminalleri',
        ...
        },
        {
          ...
          translations: {
            da: 'Terminalinteraktioner',
            de: 'Terminalinteraktionen',
            en: 'Terminal interactions',
            es: 'Interacciones de terminal',
            fr: 'Interactions avec le terminal',
            hi: 'टर्मिनल इंटरैक्शन',
            id: 'Interaksi terminal',
            it: 'Interazioni con il terminale',
            ja: 'ターミナル操作',
            ko: '터미널 상호 작용',
            'pt-BR': 'Interações de terminal',
            ru: 'Взаимодействие с терминалом',
            tr: 'Terminal etkileşimleri',
        ...
        },
        {
          ...
          translations: {
            da: 'Terminalautomatisering',
            de: 'Terminalautomatisierung',
            en: 'Terminal automation',
            es: 'Automatización de terminales',
            fr: 'Automatisation des terminaux',
            hi: 'टर्मिनल स्वचालन',
            id: 'Otomatisasi terminal',
            it: 'Automazione del terminale',
            ja: 'ターミナルの自動化',
            ko: '터미널 자동화',
            'pt-BR': 'Automação de terminal',
            ru: 'Автоматизация терминала',
            tr: 'Terminal otomasyonu',
