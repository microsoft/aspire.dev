      ...
      items: [
        ...
        },
        {
          ...
          translations: {
            ...
            de: 'Container-Images',
            en: 'Container images',
            es: 'Imágenes de contenedor',
            fr: 'Images de conteneur',
            hi: 'कंटेनर इमेज',
            id: 'Image kontainer',
            it: 'Immagini dei container',
            ja: 'コンテナーイメージ',
            ko: '컨테이너 이미지',
            'pt-BR': 'Imagens de contêiner',
            ru: 'Образы контейнеров',
            tr: 'Kapsayıcı görüntüleri',
            uk: 'Образи контейнерів',
            'zh-CN': '容器映像',
          },
          slug: 'reference/container-images',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          translations: {
            da: "Søg i AppHost API'er",
            de: 'AppHost APIs durchsuchen',
            en: 'Search AppHost APIs',
            es: 'Buscar API de AppHost',
            fr: 'Rechercher les API AppHost',
            hi: 'AppHost एपीआई खोजें',
            id: 'Cari API AppHost',
            it: 'Cerca API AppHost',
            ja: 'AppHost APIを検索する',
            ko: 'AppHost API 검색',
            'pt-BR': 'Pesquisar APIs AppHost',
            ru: 'Поиск AppHost API',
            tr: "AppHost API'lerini Arayın",
            uk: 'Пошук AppHost API',
            'zh-CN': '搜索 AppHost API',
          },
