export const redirects = {
  ...
  '/app-host/polyglot-apphost/': '/get-started/first-app/?lang=javascript',
  '/app-host/polyglot-migration/': '/get-started/first-app/?lang=javascript',
  '/app-host/polyglot-troubleshooting/': '/get-started/first-app/?lang=javascript',
};
