...
import heroImage from '../../src/assets/aspire-hero.png';
import samplesData from '../../src/data/samples.json';
...
import CodespacesButton from '../../src/components/CodespacesButton.astro';
import Expand from '../../src/components/Expand.astro';
import FeatureShowcase from '../../src/components/FeatureShowcase.astro';
import FluidGrid from '../../src/components/FluidGrid.astro';
import FooterPreferences from '../../src/components/FooterPreferences.astro';
import FreeAndOpenSourceAside from '../../src/components/FreeAndOpenSourceAside.astro';
import GitHubRepoStats from '../../src/components/GitHubRepoStats.astro';
import HeroSection from '../../src/components/HeroSection.astro';
import IconAside from '../../src/components/IconAside.astro';
import IconLinkCard from '../../src/components/IconLinkCard.astro';
import ImageShowcase from '../../src/components/ImageShowcase.astro';
import InstallAspireCLI from '../../src/components/InstallAspireCLI.astro';
import InstallCliModal from '../../src/components/InstallCliModal.astro';
import InstallDotNetPackage from '../../src/components/InstallDotNetPackage.astro';
import InstallPackage from '../../src/components/InstallPackage.astro';
import Integrations from '../../src/components/Integrations.astro';
import IntegrationTotals from '../../src/components/IntegrationTotals.astro';
import LanguagesSupported from '../../src/components/LanguagesSupported.astro';
import LearnMore from '../../src/components/LearnMore.astro';
import LicenseBadge from '../../src/components/LicenseBadge.astro';
import LocalVsProdEnvironments from '../../src/components/LocalVsProdEnvironments.astro';
import LoopingVideo from '../../src/components/LoopingVideo.astro';
import MediaCard from '../../src/components/MediaCard.astro';
import OsAwareTabs from '../../src/components/OsAwareTabs.astro';
import Pivot from '../../src/components/Pivot.astro';
import PivotSelector from '../../src/components/PivotSelector.astro';
import Placeholder from '../../src/components/Placeholder.astro';
import QuickStartJourney from '../../src/components/QuickStartJourney.astro';
import SampleCard from '../../src/components/SampleCard.astro';
import SampleGrid from '../../src/components/SampleGrid.astro';
import SessionCard from '../../src/components/SessionCard.astro';
import SessionGrid from '../../src/components/SessionGrid.astro';
import SimpleAppHostCode from '../../src/components/SimpleAppHostCode.astro';
import SimpleCard from '../../src/components/SimpleCard.astro';
import TestimonialCarousel from '../../src/components/TestimonialCarousel.astro';
import ThemeImage from '../../src/components/ThemeImage.astro';
import ThreeTierAspire from '../../src/components/ThreeTierAspire.astro';
import TopicHero from '../../src/components/TopicHero.astro';
import TwitchEmbed from '../../src/components/TwitchEmbed.astro';
import VimeoCard from '../../src/components/VimeoCard.astro';
import VimeoGrid from '../../src/components/VimeoGrid.astro';
import YouTubeCard from '../../src/components/YouTubeCard.astro';
import YouTubeEmbed from '../../src/components/YouTubeEmbed.astro';
import YouTubeGrid from '../../src/components/YouTubeGrid.astro';
