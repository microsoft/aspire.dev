...
<Aside type="tip">
Pick the AppHost language that best fits your repo and team. Your workloads do not need to match it.
</Aside>
...
<CardGrid>
  <Card title="Java apps">
    ...
    Start with [Java integration](/integrations/frameworks/java/java-get-started/).
  </Card>

  <Card title="Rust apps">
    Add Rust services through the Community Toolkit.

    Start with [Rust integration](/integrations/frameworks/rust/rust-get-started/).
  </Card>

  <Card title="PowerShell scripts and tools">
    Add PowerShell-based scripts and developer tools through the Community Toolkit.

    Start with [PowerShell integration](/integrations/frameworks/powershell/powershell-get-started/).
  </Card>
</CardGrid>
