...
<LearnMore>
  For more details, see [TypeScript AppHost](/get-started/first-app/?lang=javascript).
</LearnMore>
...
Follow the directions in [Upgrade to Aspire 13.2](#upgrade-to-aspire-132) to move forward and start using the new CLI, TypeScript AppHost, dashboard, hosting, and integration capabilities in this release.
