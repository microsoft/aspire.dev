...
<LearnMore>
For more details, see [Azure AI Inference integration](/integrations/cloud/azure/azure-ai-inference/).
</LearnMore>
...
<LearnMore>
For more details, see [Azure App Service integration](/integrations/cloud/azure/azure-app-service/).
</LearnMore>
