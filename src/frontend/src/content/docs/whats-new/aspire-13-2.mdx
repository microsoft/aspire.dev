...
### Browse documentation from the CLI (`aspire docs`)
...
For comprehensive upgrade guidance, see [Upgrade Aspire](/whats-new/upgrade-aspire/).
...
<ThemeImage
    ...
    dark={resourcesDark}
    alt="Aspire 13.2 dashboard resources page showing running resources with status indicators"
/>
...
<ThemeImage
    light={structuredLogsLight}
    dark={structuredLogsDark}
    alt="Aspire 13.2 dashboard structured logs page with resource filtering and log level indicators"
/>
...
<ThemeImage
    light={consoleLogsLight}
    dark={consoleLogsDark}
    alt="Aspire 13.2 dashboard console logs page showing color-coded resource output"
/>
