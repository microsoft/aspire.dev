...
<Aside type="note">
These APIs existed in Aspire 13.1 but did not behave as expected. In Aspire 13.2, they now correctly resolve endpoints based on the specified context.
</Aside>

<LearnMore>
For more details, see:
- [GitHub Issue #7153](https://github.com/dotnet/aspire/issues/7153)
- [GitHub PR #14278](https://github.com/dotnet/aspire/pull/14278)
- [Context-based endpoint resolution](/architecture/resource-hierarchies/#context-based-endpoint-resolution)
</LearnMore>
