...
description: Aspire 13.2 introduces detached mode for long-running apps, the aspire ps and doctor commands, TypeScript AppHost support, .env file exports, dashboard telemetry management, Azure Virtual Network and private endpoint support, and numerous polyglot improvements.
sidebar:
  label: Aspire 13.2
  order: 0
tableOfContents:
