...
For more information, see the [MongoDB Entity Framework Core integration documentation](/integrations/databases/efcore/mongodb/mongodb-efcore-get-started/).
...
<LearnMore>
Learn more about [configuring image pull policy](/integrations/compute/docker/#configure-image-pull-policy).
</LearnMore>
...
<LearnMore>
Learn more about [image pull policy in Docker Compose](/integrations/compute/docker/#image-pull-policy-in-docker-compose) and the [Docker Compose to AppHost reference](/app-host/docker-compose-to-apphost-reference/#pull-policy).
</LearnMore>
