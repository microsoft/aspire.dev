...
resourceImage: ~/assets/whats-new/aspire-9/console-logs-ansi-text-format.png
...
import consoleLogsAnsiTextFormat from '@assets/whats-new/aspire-9/console-logs-ansi-text-format.png';
import dashboardBrowserTelemetry from '@assets/whats-new/aspire-9/dashboard-browser-telemetry.png';
import waitingForUnhealthyResource from '@assets/whats-new/aspire-9/waiting-for-unhealthy-resource.png';
import healthCheckDetails from '@assets/whats-new/aspire-9/health-check-details.png';
import persistentContainer from '@assets/whats-new/aspire-9/persistent-container.png';
import persistentContainerDockerDesktop from '@assets/whats-new/aspire-9/persistent-container-docker-desktop.png';
import redisInsight from '@assets/whats-new/aspire-9/redis-insight.png';
import functionsStep1 from '@assets/whats-new/aspire-9/functions-step-1.gif';
import functionsDashboardScreenshot from '@assets/whats-new/aspire-9/functions-dashboard-screenshot.png';
import functionsDebugScreenshot from '@assets/whats-new/aspire-9/functions-debug-screenshot.png';
...
<Image src={consoleLogsAnsiTextFormat} alt="Colorful console logs" />
...
The dashboard supports OpenTelemetry Protocol (<abbr title="OpenTelemetry Protocol" data-tooltip-placement="top">OTLP</abbr>) over HTTP and cross-origin resource sharing (CORS). These features unlock the ability to send OpenTelemetry from browser apps to the Aspire dashboard.
...
<Image src={dashboardBrowserTelemetry} alt="Trace detail page with browser telemetry" />
...
<Image src={waitingForUnhealthyResource} alt="Waiting for an unhealthy resource before starting" />
...
<Image src={healthCheckDetails} alt="Health check details in the dashboard's resource details view" />
...
The AppHost now supports _persistent_ containers. Persistent containers deviate from the typical container life cycle of Aspire orchestrated apps. While they're _created_ and _started_ (when not already available) by the Aspire orchestrator, they're not destroyed by Aspire.
...
<Image src={persistentContainer} alt="Persistent containers" />

After the AppHost is stopped, the container will continue to run:

<Image src={persistentContainerDockerDesktop} alt="Docker desktop showing RabbitMQ" />
...
<Image src={redisInsight} alt="Redis Insight dashboard showing multiple Redis instances" />

For more information, see [Add Redis resource with Redis Insights](/integrations/caching/redis/redis-host/#add-redis-resource-with-redis-insight).
...
Read [Azure-agnostic client resolution](https://github.com/microsoft/aspire/blob/release/9.0/src/Components/Aspire.Azure.AI.OpenAI/README.md#azure-agnostic-client-resolution) for more details.
...
- [Aspire: Azure PostgreSQL hosting integration](/integrations/cloud/azure/azure-postgresql/azure-postgresql-host/).
- [Aspire: Azure Redis hosting integration](/integrations/cloud/azure/azure-cache-redis/azure-cache-redis-host/).
...
<Image src={functionsStep1} alt="Create new Aspire Azure Functions project" />
...
Set a breakpoint on the first `logger.LogInformation` line of the `Run` method and press <Kbd windows="F5" /> to start the Functions host. Once the Aspire dashboard launches, you observe the following:

<Image src={functionsDashboardScreenshot} alt="Screenshot of the Aspire running with an Azure Function app" />
...
<Image src={functionsDebugScreenshot} alt="Screenshot of the Aspire dashboard: Debugging an Azure Function app" />
...
For more information, see the official [Aspire Azure Functions integration (Preview)](/integrations/cloud/azure/azure-functions/azure-functions-get-started/).
...
Aspire is built in the open, and this release wouldn't be what it is without you. A huge thank you to everyone who helped make Aspire 9.0 possible.

<ReleaseCommunity version="9.0" />