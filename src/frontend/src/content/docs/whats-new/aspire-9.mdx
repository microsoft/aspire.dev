...
<Image
  src={dashboardBrowserTelemetry}
  alt="Trace detail page with browser telemetry"
/>
...
<Image
  src={waitingForUnhealthyResource}
  alt="Waiting for an unhealthy resource before starting"
/>
...
<Image
  src={healthCheckDetails}
  alt="Health check details in the dashboard's resource details view"
/>
...
<Aside type="caution">
  To delete these containers, you must manually stop them using the container
  runtime.
</Aside>
...
<Image
  src={persistentContainerDockerDesktop}
  alt="Docker desktop showing RabbitMQ"
/>
...
<Aside type="caution">
  These Aspire dashboard commands are only available when running the dashboard
  locally. They're not available when running the dashboard in Azure Container
  Apps.
</Aside>
...
<Image
  src={redisInsight}
  alt="Redis Insight dashboard showing multiple Redis instances"
/>
...
<Image
  src={functionsDashboardScreenshot}
  alt="Screenshot of the Aspire running with an Azure Function app"
/>
...
<Image
  src={functionsDebugScreenshot}
  alt="Screenshot of the Aspire dashboard: Debugging an Azure Function app"
/>
