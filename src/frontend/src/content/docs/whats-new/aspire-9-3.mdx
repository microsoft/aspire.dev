...
resourceImage: ~/assets/whats-new/aspire-9.3/dashboard-copilot.png
...
If you have feedback, questions, or want to contribute to Aspire, collaborate with us on [GitHub](https://github.com/microsoft/aspire) or join us on [Discord](https://aka.ms/dotnet-discord) to chat with team members.
...
<Image src={dashboardCopilot} alt="Screenshot of dashboard with GitHub Copilot chat open." />

For more details on requirements and how to get started, see [Dashboard and AI coding agents](https://aspire.dev/dashboard/ai-coding-agents/).
...
<Image src={dashboardFilter} alt="Screenshot of dashboard resource's page showing the filter popup." />
...
Previously, these dependencies were invisible in the **Traces** view unless they were emitting <abbr title="OpenTelemetry Protocol" data-tooltip-placement="top">OTLP</abbr> traces. Now, if your app makes an HTTP, SQL, or Redis call to a **modeled Aspire resource** that doesn't emit spans itself, Aspire still shows it as a **referenced peer** in the trace timeline.
...
<Image src={dashboardTracesUninstrumentedResources} alt="Screenshot of dashboard traces's page showing added resources in results." />
...
<Image src={dashboardContextMenu} alt="Screenshot of dashboard resource graph view with a context menu." />
...
<Image src={dashboardMetricsWarning} alt="Screenshot of dashboard metrics page with a pause warning." />
...
Aspire is built in the open, and this release wouldn't be what it is without you. A huge thank you to everyone who helped make Aspire 9.3 possible.

<ReleaseCommunity version="9.3" />
