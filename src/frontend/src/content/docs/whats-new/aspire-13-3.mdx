...
Azure Container Registry now supports [private endpoints](/integrations/cloud/azure/azure-virtual-network/#add-private-endpoints), enabling secure, VNet-only access to your registry. Call `AddPrivateEndpoint` on a subnet and pass the registry resource:
...
Aspire automatically upgrades the registry SKU to **Premium** (required for private endpoint support) and disables public network access.

<LearnMore>
  For more details, see [Azure Container Registry: private endpoints](/integrations/cloud/azure/azure-container-registry/azure-container-registry-host/#use-private-endpoints).
</LearnMore>
