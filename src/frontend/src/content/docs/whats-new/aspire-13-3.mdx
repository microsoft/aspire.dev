...
Point any OTLP-compatible application at the address `aspire dashboard run` prints, and your logs, traces, and metrics show up in the dashboard live. The container image is still available for environments where running the CLI isn't an option.
