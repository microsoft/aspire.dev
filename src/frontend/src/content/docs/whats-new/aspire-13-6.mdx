...
- Long resource names in dashboard dropdown selectors, such as the Console logs and Metrics resource pickers, stay on one line and truncate with an ellipsis instead of being abruptly cut off. The full name is still shown when you open the dropdown.
