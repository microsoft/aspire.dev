...
resourceImage: ~/assets/whats-new/aspire-9.1/dashboard-parentchild.png
...
import dashboardParentChild from '@assets/whats-new/aspire-9.1/dashboard-parentchild.png';
import dashboardLanguage from '@assets/whats-new/aspire-9.1/dashboard-language.png';
import dashboardRemoveTelemetry from '@assets/whats-new/aspire-9.1/dashboard-remove-telemetry.png';
import dashboardFilter from '@assets/whats-new/aspire-9.1/dashboard-filter.png';
import dashboardResourceDetails from '@assets/whats-new/aspire-9.1/dashboard-resourcedetails.png';
import consoleLogsDownload from '@assets/whats-new/aspire-9.1/consolelogs-download.png';
...
<Image src={dashboardParentChild} alt="A screenshot of the Aspire dashboard showing the Postgres resource with a database nested underneath it" />
...
<Image src={dashboardLanguage} alt="A screenshot of the Aspire dashboard showing the new flyout menu to change language" />
...
<Image src={dashboardRemoveTelemetry} alt="A screenshot of the Aspire dashboard showing the remove button on the structured logs page" />
...
<Image src={dashboardFilter} alt="A screenshot of the Aspire dashboard showing the new filter options" />
...
<Image src={dashboardResourceDetails} alt="A screenshot of the Aspire dashboard with references and back references showing" />
...
<Image src={consoleLogsDownload} alt="A screenshot of the console logs page with the download button, turn off timestamps button, and logs that don't show timestamps" />
...
- [Azure Cosmos DB Linux-based (preview)](/integrations/cloud/azure/azure-cosmos-db/azure-cosmos-db-host/#run-as-preview-emulator-linux-based)
- [Azure SignalR](/integrations/cloud/azure/azure-signalr/azure-signalr-host/#add-azure-signalr-service-emulator-resource)
...
- [Azure Event Hubs](/integrations/cloud/azure/azure-event-hubs/azure-event-hubs-host/#run-as-emulator)
- [Azure Cosmos DB](/integrations/cloud/azure/azure-cosmos-db/azure-cosmos-db-host/#run-as-emulator)
...
We recognize there's more work to be done in the area of deployment. Future releases will continue to address these opportunities for improvement. For more information on deploying Aspire to ACA, see [Deploy an Aspire project to Azure Container Apps](/deployment/azure/container-apps/).
...
Aspire is built in the open, and this release wouldn't be what it is without you. A huge thank you to everyone who helped make Aspire 9.1 possible.

<ReleaseCommunity version="9.1" />
