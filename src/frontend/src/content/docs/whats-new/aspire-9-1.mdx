...
1. Update to the latest [Aspire templates](/get-started/aspire-sdk-templates/) by running the following .NET command line:
   ...
   <Aside type="note">
     The `dotnet new update` command updates all of your templates to the latest
     version.
   </Aside>
...
<Image
  src={dashboardParentChild}
  alt="A screenshot of the Aspire dashboard showing the Postgres resource with a database nested underneath it"
/>
...
<Image
  src={dashboardLanguage}
  alt="A screenshot of the Aspire dashboard showing the new flyout menu to change language"
/>
...
<Image
  src={dashboardRemoveTelemetry}
  alt="A screenshot of the Aspire dashboard showing the remove button on the structured logs page"
/>
...
<Aside type="tip">
  If you're interested in contributing to Aspire, look for issues labeled with
  [good first
  issue](https://github.com/dotnet/aspire/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22)
  and follow the [contributor
  guide](https://github.com/dotnet/aspire/blob/main/docs/contributing.md).
</Aside>
...
<Image
  src={dashboardFilter}
  alt="A screenshot of the Aspire dashboard showing the new filter options"
/>
...
<Image
  src={dashboardResourceDetails}
  alt="A screenshot of the Aspire dashboard with references and back references showing"
/>
...
<Image
  src={consoleLogsDownload}
  alt="A screenshot of the console logs page with the download button, turn off timestamps button, and logs that don't show timestamps"
/>
