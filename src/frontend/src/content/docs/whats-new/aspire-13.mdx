...
Unlike the deprecated `AddNpmApp` API, `AddJavaScriptApp` does not support an `args` parameter for passing command-line arguments directly to scripts. You have two options to pass arguments:
