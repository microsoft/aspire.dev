...
Aspire 13.0 introduces multi-language-friendly environment variables that make service discovery easier for non-.NET applications.
...
- [**Blazor & Minimal API starter**](/get-started/first-app-csharp-apphost/?lang=csharp): Full-stack .NET application with Blazor frontend and ASP.NET Core API.
