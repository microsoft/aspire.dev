...
seoTitle: "Aspire 13.5: AppHost interactivity and TypeScript GA"
description: "Explore Aspire 13.5 updates for interactive AppHosts, TypeScript GA, the CLI, dashboard, Visual Studio Code, and cloud deployment."
sidebar:
  label: Aspire 13.5
  order: 0
tableOfContents:
...
- Persistent storage for Kubernetes and AKS, more predictable Azure hosting, and new or updated integrations.
