...
- **Dashboard navigation and responsive layout improvements**: The Dashboard now has a collapsible left navigation rail that remembers its state, left-aligned page titles, and responsive page toolbars that wrap or stack on narrower screens. Typography, contrast, and accessibility are improved across core pages and dialogs.
