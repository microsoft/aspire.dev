...
### GitHub Models and Microsoft Foundry typed catalogs
...
- [Aspire Microsoft Foundry integration (Preview)](https://aspire.dev/integrations/cloud/azure/azure-ai-foundry/azure-ai-foundry-get-started/).
