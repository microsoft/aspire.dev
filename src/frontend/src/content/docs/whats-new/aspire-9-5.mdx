...
<Aside type="note" title="Try out the new update command!">
...
1. In your AppHost project file (that is, _MyApp.AppHost.csproj_), update the [📦 Aspire.AppHost.Sdk](https://www.nuget.org/packages/Aspire.AppHost.Sdk) NuGet package to version `9.5.0`:
    ...
    For more information, see [Aspire SDK](https://learn.microsoft.com/dotnet/aspire/fundamentals/dotnet-aspire-sdk).
...
1. Update to the latest [Aspire templates](https://learn.microsoft.com/dotnet/aspire/fundamentals/aspire-sdk-templates) by running the following .NET command line:
...
If your AppHost project file doesn't have the `Aspire.AppHost.Sdk` reference, you might still be using Aspire 8. To upgrade to 9, follow [the upgrade guide](https://learn.microsoft.com/dotnet/aspire/get-started/upgrade-to-aspire-9).
