...
- **Custom deployment hooks** to execute custom logic during the `aspire deploy` command
...
The example below shows the modern pipeline-step approach for custom deployment behavior and showcases [CLI-based prompting](#-enhanced-publish-and-deploy-output) and progress notifications.
