...
If your AppHost project file doesn't have the `Aspire.AppHost.Sdk` reference, you might still be using Aspire 8. To upgrade to 9.0, follow [the upgrade guide](/get-started/upgrade-to-9/).
...
- [Add SQL Server resource with database scripts](/integrations/databases/sql-server/#add-sql-server-resource-with-database-scripts)
...
See the [breaking changes](/compatibility/9.2/) page for more details.
...
- [Breaking changes in Aspire 9.2](/compatibility/9.2/)
