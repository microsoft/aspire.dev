...
// Agent suggests: "Adding Redis cache with [📦 Aspire.Hosting.Redis](https://www.nuget.org/packages/Aspire.Hosting.Redis)"
...
<OsAwareTabs syncKey="terminal">    
  ...
  <Code
    slot='windows'
    lang="powershell"
    code='irm https://aspire.dev/install.ps1 | iex -SkipPath'
  />
</OsAwareTabs>
...
Aspire 13.1 addresses this by moving toward explicit container registry configuration, giving developers more control and visibility into where and when images are pushed. This improves reliability, speeds up deployments, and enables custom registries for advanced scenarios.
...
- [📦 Azure.Provisioning.RedisEnterprise](https://www.nuget.org/packages/Azure.Provisioning.RedisEnterprise) updated to 1.1.0 (uses Azure API version `2025-07-01`).
- [📦 Azure.Provisioning.AppService](https://www.nuget.org/packages/Azure.Provisioning.AppService) updated.
- [📦 Aspire.Npgsql](https://www.nuget.org/packages/Aspire.Npgsql) updated to version 10.
...
<LearnMore>
Learn more about the [Azure Functions integration](/integrations/cloud/azure/azure-functions/).
</LearnMore>
