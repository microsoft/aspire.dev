...
<Aside type="note">
If you are on a version of the Aspire CLI less than 13, please use the [installation instructions from getting started](/get-started/install-cli/) to install the latest stable version.
</Aside>
