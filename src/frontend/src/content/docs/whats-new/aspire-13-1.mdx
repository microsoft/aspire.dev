...
- **JavaScript improvements**: New front-end starter template, Vite HTTPS configuration, and pnpm fixes.
...
## 🌐 JavaScript and front-end support

### JavaScript front-end starter template

A new `aspire-ts-cs-starter` template provides a ready-to-use JavaScript front-end setup:
...
<LearnMore>
Learn more about the [JavaScript front-end integration](/integrations/frameworks/javascript/).
</LearnMore>
