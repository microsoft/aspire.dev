...
Only channels that are registered as _explicit_ in the packaging service are persisted; the implicit stable default is intentionally not pinned so it remains portable across environments.
