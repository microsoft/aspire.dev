...
- List all running AppHosts in table format:
  ...
  ./src/MyApp.AppHost/MyApp.AppHost.csproj            10.0.0  12345  12340    https://localhost:17244/login?t=abc123
  /home/user/other/OtherApp.AppHost.csproj            10.0.0  67890  67885    https://localhost:17250/login?t=def456
  ```
