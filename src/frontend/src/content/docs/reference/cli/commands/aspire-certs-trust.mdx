...
On Linux, you can override which NSS databases the CLI trusts through the
[`certificates.nssDbPaths`](../../configuration/#configure-browser-certificate-trust-on-linux)
configuration setting, for example when Firefox or Chromium profiles live
outside their usual locations.
