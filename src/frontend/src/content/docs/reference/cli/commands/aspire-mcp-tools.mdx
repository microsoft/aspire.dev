...
The `aspire mcp tools` command lists the <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr> tools exposed by resources in a running AppHost. Use it to discover which resources expose tools and which tool names you can pass to `aspire mcp call`.
...
- List <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr> tools for the current AppHost:
