...
description: Use aspire update to update Aspire packages, templates, and repository CLI references, with channel selection and non-interactive options.
sidebar:
  badge: Preview
---
...
`aspire update` - Update Aspire packages, templates, and repository CLI references.
