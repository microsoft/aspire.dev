...
The `aspire agent mcp` command starts the <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr> (Model Context Protocol) server, which enables AI assistants and development tools to interact with your Aspire AppHost. The <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr> server provides a standardized interface for resource management, diagnostics, and observability operations.

When the server is running, <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr>-compatible clients can connect to it to:
...
- Start the <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr> server:
