...
description: Learn about the aspire otel spans command and its usage. This command views spans from the Dashboard OpenTelemetry API.
sidebar:
  badge: Preview
---
...
`aspire otel spans` - View spans from the Dashboard OpenTelemetry API.
