...
- **`--search <query>`**
  ...
  Full-text search to filter log content. For more details on supported search syntax and field filters, see [aka.ms/aspire/cli-search](https://aka.ms/aspire/cli-search).
