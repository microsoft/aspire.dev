...
<Aside type="note">
  Environment checks time out after 30 seconds each or two minutes in aggregate.
  Installation discovery has a separate 30-second timeout. If a timeout occurs,
