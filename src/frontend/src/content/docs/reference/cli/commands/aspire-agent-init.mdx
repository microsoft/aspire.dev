...
<Aside type="note" title="Aspire workflow skills bundle">
  Aspire workflow skills are distributed through the
...
If bundle validation fails before skill installation, see [Troubleshoot skill bundle errors](/get-started/aspire-skills/#troubleshoot-skill-bundle-errors).
