...
With [Node.js](https://nodejs.org/) 20 or later, you can start the dashboard without installing the CLI by running it through [npx](https://docs.npmjs.com/cli/commands/npx):
