...
If you have the [Aspire VS Code extension](/get-started/aspire-vscode-extension/) installed, the schema is registered for `aspire.config.json` automatically — no `$schema` property or workspace configuration required.
