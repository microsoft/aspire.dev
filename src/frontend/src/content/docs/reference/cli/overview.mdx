...
The `aspire mcp` command lets you list and call <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr> tools exposed by running resources. If you need to start the <abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr> server used by compatible AI agents, use `aspire agent mcp`.
