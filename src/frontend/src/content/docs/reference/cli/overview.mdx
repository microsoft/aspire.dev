...
The following example shows the Aspire CLI welcome banner and top-level help, which is a quick way to discover commands like `aspire new` when you're getting started:

<AsciinemaPlayer src="/casts/aspire-help.cast" poster="npt:0:01" rows={15} loop={false} />
