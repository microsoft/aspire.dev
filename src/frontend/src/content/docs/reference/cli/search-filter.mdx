...
- A value with no timezone suffix (for example `2024-01-15` or `2024-01-15T09:30:00`) is treated as local time on the dashboard server and adjusted to UTC before comparison.
