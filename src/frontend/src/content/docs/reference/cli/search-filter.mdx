...
- [`aspire otel trace`](../commands/aspire-otel-trace/)
...
aspire otel trace --search "status:error duration:>500"
...
- [Command reference: `aspire otel trace`](../commands/aspire-otel-trace/)
