...
For .NET project resources, `dotnet watch` natively supports Aspire AppHosts and transitively watches .NET projects in the application:
...
Run `dotnet watch` against the AppHost project when you want the .NET SDK's watch loop for the AppHost and its .NET project resources:
