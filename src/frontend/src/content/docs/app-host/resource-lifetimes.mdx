...
:::caution[Experimental executable and project lifetimes]
Support for persistent project and executable lifetimes is newly added in Aspire 13.4 and requires the experimental shared lifetime APIs.
:::
...
const parentProcessId = Number(process.env.RESOURCE_PARENT_PROCESS_ID);
