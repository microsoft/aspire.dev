...
<LearnMore>
  Learn more about [Docker Compose build
  reference](https://docs.docker.com/compose/compose-file/build/) and
...
<LearnMore>
  Learn more about [Docker Compose
  ports](https://docs.docker.com/compose/compose-file/05-services/#ports) and
  [endpoint configuration](/fundamentals/networking-overview/).
</LearnMore>
...
<LearnMore>
  ...
  and [external parameters](/fundamentals/external-parameters/).
</LearnMore>
...
<LearnMore>
  ...
  and [persist container data](/fundamentals/persist-data-volumes/).
</LearnMore>
...
<LearnMore>
  ...
  and [launch profiles](/fundamentals/launch-profiles/).
</LearnMore>
...
<LearnMore>
  ...
  and [service discovery](/fundamentals/service-discovery/).
</LearnMore>
...
<LearnMore>
  Learn more about [Docker Compose deploy
...
<LearnMore>
  ...
  and [health checks](/fundamentals/health-checks/).
</LearnMore>
...
<LearnMore>
  ...
  and [telemetry](/fundamentals/telemetry/).
</LearnMore>
...
<LearnMore>
  Learn more about [Docker Compose
  services](https://docs.docker.com/compose/compose-file/05-services/) and
  [database integrations](/integrations/gallery/?search=database).
</LearnMore>
