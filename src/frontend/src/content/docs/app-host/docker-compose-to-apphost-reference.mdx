...
The API examples use C# method names. In TypeScript AppHosts, use the camelCase equivalents, such as `builder.addDockerfile(...)`, `resource.withDockerfile(...)`, and `builder.addDockerfileBuilder(...)`.
