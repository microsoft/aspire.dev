...
<Aside type="note">
In TypeScript AppHosts, `withTerminal()` currently applies the default options shown above. Configurable options are coming to the [polyglot](/get-started/glossary/#polyglot) API as `WithTerminal` is finalized (tracked by [microsoft/aspire#18105](https://github.com/microsoft/aspire/issues/18105)).
</Aside>
