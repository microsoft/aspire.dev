...
<Aside type="note">
  The JavaScript application itself is for you to create. Aspire orchestrates it alongside your other resources, providing service discovery and environment variables for any referenced resources.
</Aside>
