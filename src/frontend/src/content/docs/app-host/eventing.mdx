...
<Aside type="note">
  TypeScript AppHost support for resource event subscriptions isn't yet
  available.
</Aside>
...
<Aside type="note">
  TypeScript AppHost support for registering eventing subscriber services isn't
  yet available.
</Aside>
...
<Aside type="note">
  TypeScript AppHost support for eventing subscriptions isn't yet available.
</Aside>
