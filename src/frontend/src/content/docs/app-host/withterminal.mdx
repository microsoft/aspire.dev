...
Each replica gets its own independent terminal session and appears as a separate entry in the dashboard resource list. Replica names are generated for each instance.
