...
- **Front-end development servers**: Tools like [Vercel CLI](https://vercel.com/docs/cli) or webpack dev server.
...
Here's a complete example using the [Vercel CLI](https://vercel.com/docs/cli) to host a front-end application with a backend API:
