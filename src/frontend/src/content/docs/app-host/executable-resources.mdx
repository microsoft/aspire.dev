...
description: Learn how to use ExecutableResource and AddExecutable to host external executable applications in your Aspire AppHost.
---
...
// Executable with command-line arguments
const pythonApp = await builder.addExecutable(
    "api", "python", ".", "-m", "uvicorn", "main:app", "--reload", "--host", "0.0.0.0", "--port", "8000");
