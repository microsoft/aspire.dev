...
<Image src={persistentContainer} alt="Screenshot of the Aspire dashboard showing a persistent container with a pin icon." />
...
<Image src={persistentContainerDocker} alt="Screenshot of Docker Desktop showing a persistent RabbitMQ container still running after the AppHost stopped." />
