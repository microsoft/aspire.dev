...
### Serve a frontend from Nginx

You can also embed frontend assets into a dedicated web server container:
...
var nginx = builder.AddContainer("webserver", "nginx:alpine")
    .PublishWithContainerFiles(frontend, "/usr/share/nginx/html");
