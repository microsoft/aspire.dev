...
[Dev Hub](/hub/) highlights live in `src/data/dev-central.ts`, relative to `src/frontend`. Reuse existing documentation, sample IDs, and shared data rather than maintaining a separate resource catalog.
