...
Thank you for your interest in contributing to `aspire.dev`! This guide will help you get started with making contributions to our documentation. Whether you're fixing typos, adding new content, or improving existing pages, your help is greatly appreciated.

## 🚀 About this site

This documentation site is proudly built using [Starlight](https://starlight.astro.build/), a full-featured documentation theme built on top of [Astro](https://astro.build/). Starlight provides a fast, accessible, and SEO-friendly foundation for our documentation, while Astro's component-based architecture makes it easy to create and maintain content.
...
1. View the site locally
    ...
    - **Site**: `http://localhost:4321` (or the port shown in your terminal)

</Steps>

## ✍️ Writing style guide

When contributing to `aspire.dev`, please follow these writing style guidelines to ensure consistency and clarity across the documentation:

- **Use clear and concise language**: Aim for simplicity and clarity. Avoid jargon unless necessary, and explain technical terms when they first appear.
...
- **Use active voice**: Write in an active voice to make instructions and explanations more direct and engaging.
...
- **Use proper grammar and spelling**: Proofread your contributions to ensure they are free of grammatical errors and typos.
...
<Aside type="tip">
  To configure which headings are shown in the **On this page** sidebar, use the `tableOfContents` frontmatter field. See the [tableOfContents reference](https://aspire.dev.astro.build/reference/frontmatter/) for all available fields and how to add custom fields.
</Aside>
...
<Aside type="note">
  Please use use `1.` for all items in an ordered list, and Markdown will automatically number them correctly.
</Aside>
...
<LearnMore>
For all the available components see: [Starlight: Components](https://starlight.astro.build/components/using-components/).
</LearnMore>
...
To use custom components available in `aspire.dev`, import them at the top of your MDX file. Custom component imports rely of configured aliases, have a look at the `tsconfig.json` file for more information:
...
1. Fork the repository
    ...
    As mentioned in the [Local dev setup](#-local-dev-setup) section, start by forking the `aspire.dev` repository to your own GitHub account.
 
1. Create a new branch for your changes to keep your work organized:
