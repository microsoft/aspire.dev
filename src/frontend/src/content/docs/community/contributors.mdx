...
<ContributorList githubRepo="microsoft/aspire" ignore={ignore} />
<GitHubRepoStats stats={stats} repoName="microsoft/aspire" />
...
<ContributorList githubRepo="microsoft/aspire-samples" ignore={ignore} />
<GitHubRepoStats stats={stats} repoName="microsoft/aspire-samples" />
...
<ContributorList githubRepo="microsoft/dcp" ignore={ignore} />
<GitHubRepoStats stats={stats} repoName="microsoft/dcp" />
