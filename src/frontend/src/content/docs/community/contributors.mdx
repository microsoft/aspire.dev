...
<LinkButton target={'_blank'} href="https://github.com/microsoft/aspire.dev/blob/main/CONTRIBUTING.md" icon="github" iconPlacement="start" variant="secondary">
  Interested in contributing to aspire.dev?
</LinkButton>
