...
You can also switch between available languages using the language selector in the top right corner of any page:

<ThemeImage dark={languageSelector} light={languageSelectorLight} alt="Language selector dropdown in the top right corner" />
...
<LinkButton href="https://aspire.dev/i18n/" target="_blank" icon="external">
