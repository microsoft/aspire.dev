...
import customClearCacheCommandLight from '@assets/fundamentals/custom-clear-cache-command-light.png';
import customClearCacheCommandSucceeded from '@assets/fundamentals/custom-clear-cache-command-succeeded.png';
import customClearCacheCommandSucceededLight from '@assets/fundamentals/custom-clear-cache-command-succeeded-light.png';
...
<ThemeImage
  dark={customClearCacheCommand} light={customClearCacheCommandLight}
...
<ThemeImage
  dark={customClearCacheCommandSucceeded} light={customClearCacheCommandSucceededLight}
