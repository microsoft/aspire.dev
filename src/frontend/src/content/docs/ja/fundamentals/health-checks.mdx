...
import healthChecksDashboardStatusLight from '@assets/fundamentals/health-checks-dashboard-status-light.png';
...
<ThemeImage
  dark={healthChecksDashboardStatus} light={healthChecksDashboardStatusLight}
