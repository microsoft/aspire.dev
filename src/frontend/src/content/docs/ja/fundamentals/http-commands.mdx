...
import customHttpCommandHighlightedLight from '@assets/fundamentals/custom-http-command-highlighted-light.png';
import customHttpCommand from '@assets/fundamentals/custom-http-command.png';
import customHttpCommandLight from '@assets/fundamentals/custom-http-command-light.png';
import customHttpCommandStarting from '@assets/fundamentals/custom-http-command-starting.png';
import customHttpCommandStartingLight from '@assets/fundamentals/custom-http-command-starting-light.png';
import customHttpCommandSucceeded from '@assets/fundamentals/custom-http-command-succeeded.png';
import customHttpCommandSucceededLight from '@assets/fundamentals/custom-http-command-succeeded-light.png';
...
<ThemeImage
  dark={customHttpCommandHighlighted} light={customHttpCommandHighlightedLight}
...
<ThemeImage
  dark={customHttpCommand} light={customHttpCommandLight}
...
<ThemeImage
  dark={customHttpCommandStarting} light={customHttpCommandStartingLight}
...
<ThemeImage
  dark={customHttpCommandSucceeded} light={customHttpCommandSucceededLight}
