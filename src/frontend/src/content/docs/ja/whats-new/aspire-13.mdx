...
フルスタックのポリグロット アプリ（Python バックエンド + JavaScript フロントエンド）を素早く構築できます。試して、カスタマイズして、出荷しましょう。 [今すぐ作成](/ja/get-started/first-app-csharp-apphost/?lang=python) して [今すぐデプロイ](/ja/get-started/deploy-first-app-csharp/?lang=python)できます！
...
- [**Blazor & Minimal API starter**](/ja/get-started/first-app-csharp-apphost/?lang=csharp): Blazor フロントエンドと ASP.NET Core API を備えた、フルスタックの .NET アプリケーションです。
- [**React (Vite) & FastAPI starter**](/ja/get-started/first-app-csharp-apphost/?lang=python): Python と JavaScript の統合を示す、ポリグロット アプリケーションです。
