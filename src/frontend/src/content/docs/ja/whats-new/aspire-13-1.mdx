...
<LearnMore>
詳細については [Azure Functions 統合](/integrations/cloud/azure/azure-functions/azure-functions-get-started/) または [Aspire と Azure Functions の使い方](https://learn.microsoft.com/azure/azure-functions/dotnet-aspire-integration) をご参照ください。
</LearnMore>
