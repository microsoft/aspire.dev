...
import dashboardUpdateNotificationLight from '@assets/whats-new/dashboard-update-notification-light.png';
...
<ThemeImage
  dark={dashboardUpdateNotification} light={dashboardUpdateNotificationLight}
