...
import persistentContainer from '@assets/fundamentals/persistent-container-dark.png';
import persistentContainerLight from '@assets/fundamentals/persistent-container-light.png';
...
<ThemeImage
  dark={persistentContainer} light={persistentContainerLight}
