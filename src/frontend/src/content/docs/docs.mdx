...
<HeroSection
  ...
  subtitle="Aspire gives you a unified, code-first toolkit to compose, debug, and deploy cloud-native applications — all from a single project."
  ...
  steps={[
    {
      ...
      description:
        'Ensure you have the required .NET SDK, container runtime, and tooling installed on your machine.',
...
<FeatureShowcase
  features={[
    ...
    },
    {
      ...
      title: 'The AppHost',
      description:
        'Define your entire app architecture in code. No YAML, no configuration drift — just C# that describes services and dependencies.',
    ...
    },
    {
      ...
      description:
        'Stop writing boilerplate connection strings. Aspire resources automatically wire up services, databases, and cloud integrations.',
    ...
    },
    {
      ...
      description:
        'Deploy anywhere with confidence. Your local dev setup automatically translates to Kubernetes, Azure, or any cloud provider.',
