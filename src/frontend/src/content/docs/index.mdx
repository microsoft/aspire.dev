...
banner:
  content: |
    <strong>Aspire 13.2 is here!</strong> Get the latest release that brings TypeScript AppHost authoring, an agent-native CLI, and so much more. — <a href="/whats-new/aspire-13-2/">Get Aspire 13.2</a>
hero:
  tagline: Your stack, streamlined. <p>Orchestrate frontends, APIs, containers, and databases effortlessly—no rewrites, no limits. Extend Aspire to power any project. Free, open-source, and agent ready.</p>
  image:
    alt: Aspire logo
...
<FluidGrid minColumnWidth="30rem" gap="2rem">
  ...
  >
    Orchestrate frontends, APIs, containers, and databases with zero rewrites.
  ...
  <SimpleCard
    title="Your coding agents, supercharged"
    icon="star"
    link="/get-started/ai-coding-agents/"
  >
    Aspire is the control plane for agentic dev. AI agents use your app model to
    understand, build, and operate your entire stack.
  </SimpleCard>
  <SimpleCard
