...
banner:
  content: |
    <strong>🚀 Aspire 13.2 has shipped!</strong> — <a href="/whats-new/aspire-13-2/">See what's new in Aspire 13.2.</a>
hero:
...
<FluidGrid minColumnWidth="30rem" gap="2rem">
  ...
  <SimpleCard
    ...
    link="/docs/"
  >
    Aspire is the control plane for agentic dev. AI agents use your app model
    to understand, build, and operate your entire stack.
  </SimpleCard>
  <SimpleCard
