...
<Badge text="📆 Last updated: March 3, 2026" variant="tip" size="large" />
...
| ----------- | --------------------- | -------------------- | ------------------ | -------------------------------------------- |
| Aspire 13.1 | December 17, 2025     | 13.1.2               | February 25, 2026  | When next major or minor version is released. |
