...
description: Understand how the Aspire Redis distributed caching integration fits together — model a Redis resource in your AppHost, then register an IDistributedCache in your consuming C# app.
---
...
architecture-beta
  ...
  service client(iconoir:server-connection)[Aspire.StackExchange.Redis.DistributedCaching] in consumer
