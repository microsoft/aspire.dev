---
title: Redis Output Caching hosting integration
description: Learn how to use the Redis Output Caching hosting integration to add a Redis resource to your AppHost.
---
