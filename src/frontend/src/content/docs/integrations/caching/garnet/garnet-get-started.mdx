...
description: Understand how the Aspire Garnet integrations fit together — model a Garnet resource in your AppHost, then connect to it from any consuming app.
---
