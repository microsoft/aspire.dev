...
The Redis distributed caching integration is used to register an [IDistributedCache](https://learn.microsoft.com/dotnet/api/microsoft.extensions.caching.distributed.idistributedcache) provider backed by a Redis server.
