...
description: Understand how the Aspire Apache Kafka integrations fit together — model a Kafka resource in your AppHost, then connect to it from any consuming app.
---
