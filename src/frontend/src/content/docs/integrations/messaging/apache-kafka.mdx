---
title: Apache Kafka
description: Learn how to use the Apache Kafka integration to build event-driven applications.
---
...
<InstallPackage packageName="Aspire.Hosting.Kafka" shortName="kafka" />
...
<Aside type="tip">
If you'd rather connect to an existing Kafka server, call `AddConnectionString` instead. For more information, see [Reference existing resources](/fundamentals/app-host-overview/#reference-existing-resources).
</Aside>
...
<Aside type="note">
For more information about connection strings in Aspire, see [Reference existing resources](/fundamentals/app-host-overview/#reference-existing-resources).
</Aside>
