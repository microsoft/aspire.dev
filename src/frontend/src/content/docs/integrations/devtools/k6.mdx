...
[Grafana k6](https://k6.io/) is a performance & load testing tool. The Aspire k integration enables you to create new container instances from Aspire with the `docker.io/grafana/k6` container image.
