---
title: Dev Tunnels
description: Learn how to use the Dev Tunnels integration to securely expose local endpoints publicly during development.
---
...
[Dev tunnels](/azure/developer/dev-tunnels/overview) allow developers to securely share local web services across the internet. The Dev Tunnels integration makes it easy to model dev tunnels in your AppHost projects so that they're automatically managed during development.
...
Before you create a dev tunnel, you first need to download and install the devtunnel CLI (Command Line Interface) tool that corresponds to your operating system. See the [devtunnel CLI installation documentation](/azure/developer/dev-tunnels/get-started#install) for more details.
...
<InstallPackage packageName="Aspire.Hosting.DevTunnels" shortName="devtunnels" prerelease={true} />
