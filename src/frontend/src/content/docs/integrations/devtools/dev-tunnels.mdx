...
- **Inspect URL** &mdash; the [dev tunnels inspect](https://learn.microsoft.com/azure/developer/dev-tunnels/inspect-tunneling-http-requests) URL for viewing tunneled HTTP traffic
