...
The Aspire Azure Service Bus hosting integration models the various Service Bus resources as the following types:
...
[Azure Service Bus](https://azure.microsoft.com/services/service-bus/) is a fully managed enterprise message broker with message queues and publish-subscribe topics.
...
<InstallPackage packageName="Aspire.Hosting.Azure.ServiceBus" shortName="azure-service-bus" />
...
By default, Aspire integrations enable health checks for all services. For more information, see [Aspire integrations overview](/fundamentals/integrations-overview/).
