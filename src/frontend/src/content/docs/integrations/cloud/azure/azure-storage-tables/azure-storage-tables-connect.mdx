...
<Aside type="tip">
    If your app expects specific environment variable names different from the Aspire defaults, you can pass individual connection properties from the AppHost using `WithEnvironment`. See [Pass environment variables](/app-host/withenvironment/) in the AppHost reference.
</Aside>
