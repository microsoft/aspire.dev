...
<InstallPackage packageName="Aspire.Hosting.Azure.Search" shortName="azure-search" />
...
- [Azure.Search.Documents documentation](/dotnet/api/azure.search.documents) for examples on using the `SearchIndexClient`.
