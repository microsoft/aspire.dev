...
To access these types and APIs for expressing them within your [AppHost](/get-sstarted/app-host/) project, install the [📦 Aspire.Hosting.Azure.EventHubs](https://www.nuget.org/packages/Aspire.Hosting.Azure.EventHubs) NuGet package:
