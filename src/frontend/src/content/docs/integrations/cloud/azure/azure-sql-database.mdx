...
[Azure SQL Database](https://learn.microsoft.com/azure-sql) is a relational database service in the Microsoft cloud. The Aspire Azure SQL Database integration enables you to connect to Azure-hosted or local SQL Server databases.

[SQL Server](https://www.microsoft.com/sql-server) is a relational database management system developed by Microsoft.
...
For more information on treating Azure SQL resources as existing resources, see [Use existing Azure resources](https://learn.microsoft.com/integrations-overview/#use-existing-azure-resources).
...
- [Microsoft.Data.SqlClient documentation](/sql/connect/ado-net/introduction-microsoft-data-sqlclient-namespace) for examples on using the `SqlConnection`.
