...
<InstallPackage packageName="Aspire.Hosting.Azure.WebPubSub" shortName="azure-web-pubsub" />
...
For more information on treating Azure Web PubSub resources as existing resources, see [Use existing Azure resources](https://learn.microsoft.com/integrations-overview/#use-existing-azure-resources).
