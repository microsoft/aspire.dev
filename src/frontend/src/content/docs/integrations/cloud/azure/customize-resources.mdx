...
For the complete factory method reference, C# SDK and Bicep mappings, and Storage and Key Vault examples, see [Compose Azure infrastructure with Bicep helpers](/integrations/cloud/azure/bicep-helpers/).
