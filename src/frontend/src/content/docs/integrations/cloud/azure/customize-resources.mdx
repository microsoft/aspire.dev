...
For integration authors, see [Generate Azure Provisioning proxies](/extensibility/multi-language-integration-authoring/#generate-azure-provisioning-proxies) for the source-generator setup, shared value handles, and projection diagnostics.
