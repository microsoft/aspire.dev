...
`AzureRoleAssignmentResource` is marked as experimental ([`ASPIREAZURE003`](/diagnostics/aspireazure003/)) as of Aspire 13.4. Its API shape may change in future releases. Suppress the diagnostic to use it:
...
#pragma warning disable ASPIREAZURE003 // AzureRoleAssignmentResource is Experimental
