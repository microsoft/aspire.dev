...
<Aside type="note">
The TypeScript AppHost does not yet support `WithRoleAssignments`. Default role assignments are applied automatically when you reference an Azure resource.
</Aside>
</TabItem>
</Tabs>
...
<TabItem id="typescript" label="TypeScript">
<Aside type="note">
The TypeScript AppHost does not yet support `WithRoleAssignments`. Role assignments cannot be overridden in a TypeScript AppHost at this time.
</Aside>
</TabItem>
</Tabs>
...
For more information, see [Aspire Azure Cosmos DB integration](/integrations/cloud/azure/azure-cosmos-db/azure-cosmos-db-get-started/).
...
- `Azure.Provisioning.Sql.SqlBuiltInRole.SqlDBContributor`
