...
- Adds an Azure OpenAI deployment resource. Replace `<model-name>` and `<model-version>` with values from the [Azure OpenAI available models](https://learn.microsoft.com/azure/ai-services/openai/concepts/models) documentation.
