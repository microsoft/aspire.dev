...
1. ### Set up App Service in your AppHost
    ...
    Add the Azure App Service hosting integration to your AppHost, then declare an App Service environment. The [Azure App Service Hosting integration](/integrations/cloud/azure/azure-app-service/azure-app-service-host/) article walks through every capability — deployment slots, infrastructure customization, application settings, and more — with side-by-side C# and TypeScript examples.
