...
Use `PublishAsAzureAppServiceWebsite` when you want to customize the Azure App Service website or deployment slot that Aspire provisions for a project. It isn't required for a standard App Service deployment.
