...
|--|--|--|--|
| `Aspire.Hosting.Foundry` | ⚠️ Foundry Local only (preferred) | ⚠️ Partial | ✅ Yes (legacy) |
...
For Foundry Local, the [Aspire.OpenAI](https://www.nuget.org/packages/Aspire.OpenAI) package provides the recommended client integration. In your service project:
