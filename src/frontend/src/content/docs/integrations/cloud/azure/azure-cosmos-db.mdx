...
[Azure Cosmos DB](https://learn.microsoft.com/azure/cosmos-db) is a globally distributed, multi-model database service. The Aspire Azure Cosmos DB integration enables you to connect to Azure Cosmos DB NoSQL databases from your applications.

If you're looking for the Entity Framework Core integration, see [Aspire Cosmos DB Entity Framework Core integration](/integrations/cloud/azure/azure-cosmos-db/).
