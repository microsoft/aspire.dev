...
description: Learn how to use the Aspire Azure AI Foundry hosting integration to create Azure AI Foundry resources.
---
...
For an introduction to working with the Azure AI Foundry hosting integration, see [Get started with the Azure AI Foundry integrations](/integrations/cloud/azure/azure-ai-foundry/azure-ai-foundry-get-started/).
