...
When you add an Azure App Service environment in your AppHost, supported compute resources run on the Azure App Service platform without needing additional client libraries or configuration changes.
