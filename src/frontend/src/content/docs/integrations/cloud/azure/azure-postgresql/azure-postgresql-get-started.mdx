...
<Aside type="tip">
    The full set of properties that Aspire injects depends on whether you passed an Azure PostgreSQL server or database resource. For more information, see [Properties of the Azure PostgreSQL resources](../azure-postgresql-client/#properties-of-the-azure-postgresql-resources).
</Aside>
