...
If you need to add a new database to an existing server, redeploy you application with the updated AppHost code or manually create the database by using the Azure portal or the PostgreSQL CLI:
