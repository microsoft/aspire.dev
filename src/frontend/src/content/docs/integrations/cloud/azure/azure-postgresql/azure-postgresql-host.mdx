...
For an introduction to working with the Azure PostgreSQL hosting integration, see [Get started with the Azure PostgreSQL integrations](../azure-postgresql-get-started/).
