...
For more information on the `IChatClient` and its corresponding library, see [Artificial intelligence in .NET (Preview)](https://learn.microsoft.com/dotnet/core/extensions/artificial-intelligence).
