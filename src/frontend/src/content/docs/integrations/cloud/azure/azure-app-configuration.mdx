...
<InstallPackage packageName="Aspire.Hosting.Azure.AppConfiguration" shortName="azure-app-configuration" />
...
For more information on treating Azure App Configuration resources as existing resources, see [Use existing Azure resources](https://learn.microsoft.com/integrations-overview/#use-existing-azure-resources).
...
- [Azure.Data.AppConfiguration documentation](/dotnet/api/azure.data.appconfiguration.configurationclient) for examples on using the `ConfigurationClient`.
