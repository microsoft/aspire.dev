...
1. ### Model Meilisearch in your AppHost
    ...
    Add the Meilisearch hosting integration to your AppHost, then declare a Meilisearch resource and reference it from the apps that need search capabilities. The [Meilisearch Hosting integration](/integrations/databases/meilisearch/meilisearch-host/) article walks through every capability — data volumes, data bind mounts, and master key parameters.
