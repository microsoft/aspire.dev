...
- `ConnectionStrings__sqlite` - The connection string containing the database file path
...
To learn how to connect to and interact with SQLite databases from your consuming projects, see [SQLite Client integration](../sqlite-client/).
