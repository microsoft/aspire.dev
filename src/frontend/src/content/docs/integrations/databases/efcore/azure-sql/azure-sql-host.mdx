...
You can connect to an existing Azure SQL Database service by using a connection string resource:
...
var sql = builder.AddConnectionString("database");
...
const database = await builder.addConnectionString("database");
...
For more information on connection string resources, see [Reference existing resources](/get-started/resources/).
