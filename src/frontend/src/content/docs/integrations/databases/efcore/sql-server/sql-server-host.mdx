---
title: SQL Server Entity Framework Core hosting integration
description: Learn how to use the Aspire SQL Server EF Core hosting integration to create SQL Server resources.
---
...
For an introduction to working with the SQL Server hosting integration, see [Get started with the SQL Server EF Core integrations](../sql-server-get-started/).
...
<Aside type="tip">
If you'd rather connect to an existing SQL Server, call `AddConnectionString` instead. For more information, see [Reference existing resources](../../../../fundamentals/app-host-overview/#reference-existing-resources).
</Aside>
