...
To get started with the Aspire Azure PostgreSQL integrations, follow the [Get started with Azure PostgreSQL integrations](../azure-postgresql-get-started/) guide.
...
<Aside type="note">
    When you call `WithReference` in the AppHost to pass Azure PostgreSQL resources to a consuming project, Aspire makes several properties available to that project, such as connection strings, URIs, and port numbers. For a complete list of these properties, see [Properties of the Azure PostgreSQL resources](../azure-postgresql-client/#properties-of-the-azure-postgresql-resources).
</Aside>
