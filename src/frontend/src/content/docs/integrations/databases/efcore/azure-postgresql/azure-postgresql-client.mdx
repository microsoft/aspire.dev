---
title: Azure PostgreSQL Client integration reference
description: Learn how to use the Aspire Azure PostgreSQL Client integration to interact with Azure PostgreSQL databases from your Aspire projects.
next: false
---
...
This article includes full details about the Aspire Azure PostgreSQL Client integration, which allows you to connect to and interact with Azure PostgreSQL databases from your Aspire consuming projects.
...
| `Password`             | The password for authentication (when using password authentication)                                                                                                            |
...
| Property Name          | Description                                                                                                                                                                                           |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Uri`                  | The connection URI in postgresql:// format, with the format `postgresql://{Username}:{Password}@{Host}:{Port}/{DatabaseName}`                                                                        |
...
> [!NOTE]
> The connection string name that you pass to the `GetConnectionString` method must match the name used when adding the PostgreSQL server resource in the AppHost project. For more information, see [Add an Azure Database for PostgreSQL resource](../azure-postgresql-host/#add-an-azure-database-for-postgresql-resource).
