...
description: Understand how the Aspire PostgreSQL EF Core integrations fit together — model a PostgreSQL resource in your AppHost, then connect to it from a .NET consuming app using Entity Framework Core.
---
