...
<Aside type="caution">
  In Aspire, EF Core is implemented by **client** integrations, not hosting
  integrations. The centralized management of the database in the AppHost
  doesn't involve EF Core, which runs in consuming microservice projects
  instead.
</Aside>

If you want to model EF Core migration management directly in the AppHost, use [Aspire.Hosting.EntityFrameworkCore](/integrations/databases/efcore/efcore-host/). That package adds an AppHost-side EF migration resource for dashboard operations, startup migrations, and publish-time migration artifacts without replacing the database-specific EF Core client packages listed on this page.
...
<Aside type="note">
  For more information about creating models in EF Core, see [Creating and
  Configuring a Model](https://learn.microsoft.com/ef/core/modeling/) in the EF
  Core documentation.
</Aside>
...
<Aside type="note">
  EF Core also supports creating, modifying, and deleting records and complex
  queries. For more information, see [Querying
  Data](https://learn.microsoft.com/ef/core/querying/) and [Saving
...
<Aside type="tip">
  For more information about SQL Server hosting and client integrations, see
  [SQL Server Entity Framework Core
  integration](/integrations/databases/efcore/sql-server/sql-server-get-started/).
</Aside>
...
<Aside type="tip">
  For more information about PostgreSQL hosting and client integrations, see
  [PostgreSQL Entity Framework Core
  integration](/integrations/databases/efcore/postgres/postgresql-get-started/).
</Aside>
...
<Aside type="tip">
  For more information about Oracle Database hosting and client integrations,
  see [Oracle Entity Framework Core
  integration](/integrations/databases/efcore/oracle/oracle-get-started/).
</Aside>
...
<Aside type="tip">
  For more information about MySQL hosting and client integrations, see [Pomelo
  MySQL Entity Framework Core
  integration](/integrations/databases/efcore/mysql/mysql-get-started/).
</Aside>
...
<Aside type="note">
  For more information about EF Core interceptors and their use, see
...
<Aside type="caution">
  Only the base context state is reset when it's returned to the pool. If you've
  manually changed the state of the `DbConnection` or another service, you must
  also manually reset it. Additionally, context pooling prevents you from using
  `OnConfiguring` to configure the context. See [DbContext
  pooling](https://learn.microsoft.com/ef/core/performance/advanced-performance-topics#dbcontext-pooling)
...
- [Set up EF Core migration management in the AppHost](/integrations/databases/efcore/efcore-host/)
