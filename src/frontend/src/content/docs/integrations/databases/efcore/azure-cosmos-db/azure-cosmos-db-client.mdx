...
For an introduction to the Azure Cosmos DB integration, see [Get started with the Azure Cosmos DB integrations](../azure-cosmos-db-get-started/).
...
When you reference an `AzureCosmosDBResource` (the account), the following properties are injected:

| Property Name | Environment Variable | Description |
|--------------|---------------------|-------------|
| `AccountEndpoint` | `[RESOURCE]_ACCOUNTENDPOINT` | The account endpoint URL for connecting to the Azure Cosmos DB account. |

### Azure Cosmos DB database properties

When you reference an `AzureCosmosDBDatabaseResource`, the following properties are injected:
...
When you reference an `AzureCosmosDBContainerResource`, the following properties are injected:

| Property Name | Environment Variable | Description |
|--------------|---------------------|-------------|
| `AccountEndpoint` | `[RESOURCE]_ACCOUNTENDPOINT` | The account endpoint URL for connecting to the Azure Cosmos DB account. |
| `DatabaseName` | `[RESOURCE]_DATABASENAME` | The name of the database containing the container. |
...
In this example, the `ExampleProject` will have access to the `MYCONTAINER_ACCOUNTENDPOINT`, `MYCONTAINER_DATABASENAME`, and `MYCONTAINER_CONTAINERNAME` environment variables, which contain the connection information to the Azure Cosmos DB container.
