...
string connectionUri = builder.Configuration.GetValue<string>("ConnectionStrings__oracledb");
```
...
connection_uri = os.getenv("ConnectionStrings__oracledb")
```
...
const connectionUri = process.env.ConnectionStrings__oracledb;
```
...
<CardGrid>
  <LinkCard
    ...
    href="/integrations/databases/oracle/oracle-host/"
  />
  <LinkCard
    ...
    href="/integrations/databases/oracle/oracle-client/"
  />
</CardGrid>
