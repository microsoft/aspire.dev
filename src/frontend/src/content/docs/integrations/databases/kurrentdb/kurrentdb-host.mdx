...
<Aside type="note">
  TypeScript AppHost support (`addKurrentDB` and related APIs) is not yet available in the generated `.aspire/modules/aspire.mts` SDK. All examples on this page are C# only.
</Aside>
