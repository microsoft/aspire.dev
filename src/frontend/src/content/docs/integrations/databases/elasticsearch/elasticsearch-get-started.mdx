...
<Aside type="tip">
    For the full set of properties that Aspire injects, see [Properties of the Elasticsearch resources](/integrations/databases/elasticsearch/elasticsearch-client/#properties-of-the-elasticsearch-resources).
</Aside>
