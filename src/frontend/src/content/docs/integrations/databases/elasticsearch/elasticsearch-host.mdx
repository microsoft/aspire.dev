...
For more information on the injected properties, see [Properties of the Elasticsearch resources](/integrations/databases/elasticsearch/elasticsearch-client/#properties-of-the-elasticsearch-resources).
