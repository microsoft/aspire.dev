...
In the Python app, you can access the Elasticsearch connection information using the environment variables that Aspire injects. Here's an example of how to connect to Elasticsearch in Python using the official `elasticsearch` client:
...
For more information on the injected properties, see [Properties of the Elasticsearch resources](../elasticsearch-client/#properties-of-the-elasticsearch-resources).
