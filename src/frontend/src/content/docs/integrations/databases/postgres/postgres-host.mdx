...
import SyncedPivotSelector from '@components/SyncedPivotSelector.astro';
...
<SyncedPivotSelector
    ...
    key="postgres-host-apphost-lang"
    syncKey="postgres-host-apphost-lang"
    options={[
        { id: "csharp", title: "C#" },
...
<Tabs syncKey="postgres-host-apphost-lang">
<TabItem label="C#">
...
<Aside type="note">
    When you reference a PostgreSQL resource from the AppHost, Aspire makes several properties available to the consuming project, such as connection strings, URIs, and port numbers. For a complete list of these properties, see [Properties of the PostgreSQL resources](../postgres-client/#properties-of-the-postgresql-resources).
</Aside>
