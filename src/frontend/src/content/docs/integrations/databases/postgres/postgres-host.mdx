...
In this article, you'll learn about the Aspire PostgreSQL Hosting integration, which allows you to model PostgreSQL server and database resources in your [`AppHost`](/get-started/welcome/) project.
