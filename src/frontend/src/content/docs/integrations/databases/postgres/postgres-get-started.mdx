...
### Include a Python PostgreSQL adapter
...
### Obtain injected PostgreSQL properties
...
### Set up a Node.js PostgreSQL client
...
import postgresqlJsDashboardLight from '@assets/integrations/postgresql/postgresql-js-dashboard-light.png';
import postgresqlJsDashboardDark from '@assets/integrations/postgresql/postgresql-js-dashboard-dark.png';
...
<ThemeImage 
    light={postgresqlJsDashboardLight}
    dark={postgresqlJsDashboardDark}
    label='Aspire dashboard Resources page'
    alt={`Aspire dashboard Resources page displaying PostgreSQL resources. Both are marked as Running with green check icons. The table lists columns for Name, State, Start time, Source, URLs, and Actions.`} />
...
<CardGrid>
  <LinkCard
    title="Learn more about the PostgreSQL hosting integration"
  ...
  />
   <LinkCard
    title="Learn more about PostgreSQL community extensions"
