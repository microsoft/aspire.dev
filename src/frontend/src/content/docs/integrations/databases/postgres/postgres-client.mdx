...
<Aside type="tip">
    If your app connects to PostgreSQL without an Aspire client integration package, you don't need one here. See [Connect to PostgreSQL](../postgres-connect/) for language-specific examples.
</Aside>
