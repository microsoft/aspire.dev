...
<Aside type="tip">
  If you plan to connect to PostgreSQL by using connection information (for example, environment variables or connection strings) directly in your application code, see [Connect to PostgreSQL](../postgres-connect/) for language-specific examples.
