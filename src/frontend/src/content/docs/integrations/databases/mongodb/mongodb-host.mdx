...
The parameter supplies the keyfile's **contents**, not a host file path. Supplying a different keyfile after `WithReplicaSet` conflicts with the generated keyfile and throws.
