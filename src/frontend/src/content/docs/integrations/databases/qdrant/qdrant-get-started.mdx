...
string connectionUri = builder.Configuration.GetValue<string>("ConnectionStrings__qdrant");
...
connection_uri = os.getenv("ConnectionStrings__qdrant")
...
const connectionUri = process.env.ConnectionStrings__qdrant;
