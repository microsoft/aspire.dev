...
string databaseport = builder.Configuration.GetValue<string>("SQLDB_PORT");
...
<Aside type="tip">
    The full set of properties that Aspire injects depends on whether you passed a SQL Server server or database resource. For more information, see [Properties of the SQL Server resources](../sql-server-client/#properties-of-the-sql-server-resources).
</Aside>
