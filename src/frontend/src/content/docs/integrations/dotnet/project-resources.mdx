...
<Image
  ...
  alt="Aspire front-end app networking diagram with specific host port and two replicas."
/>
...
<Image
  ...
  alt="Aspire front-end app networking diagram with specific host port and random port."
/>
...
<Image
  ...
  alt="Aspire front-end app networking diagram with random host port and proxy port."
/>
