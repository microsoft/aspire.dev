...
<Aside type='note'>
When you reference API endpoints from a Blazor app resource, Aspire publishes service discovery connection properties to the consuming app. For details and examples, see [Connect Blazor apps and APIs](../blazor-connect/).
</Aside>
