...
description: Understand how the Aspire OpenAI integrations fit together — model an OpenAI resource in your AppHost, then connect to it from any consuming app.
prev: false
---
