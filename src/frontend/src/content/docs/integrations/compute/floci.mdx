...
<Aside type="note">
For more information on data volumes and details on why they’re preferred over bind mounts, see [Docker docs: Volumes](https://docs.docker.com/engine/storage/volumes).
</Aside>
