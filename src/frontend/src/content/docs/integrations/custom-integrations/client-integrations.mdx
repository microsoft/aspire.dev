...
Stop the application by selecting <Kbd windows="Control+C" mac="Control+C" /> in the terminal window where the application is running, or by selecting the stop button in your IDE.
