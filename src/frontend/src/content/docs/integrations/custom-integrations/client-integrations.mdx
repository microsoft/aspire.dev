...
Stop the application by selecting <Kbd windows="Ctrl+C" mac="Command+C" /> in the terminal window where the application is running, or by selecting the stop button in your IDE.
