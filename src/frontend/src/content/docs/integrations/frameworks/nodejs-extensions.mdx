...
<InstallPackage packageName="CommunityToolkit.Aspire.Hosting.NodeJS.Extensions" shortName="nodejs-ext" />
...
- [Orchestrate Node.js apps in Aspire](/dotnet/aspire/get-started/build-aspire-apps-with-nodejs)
