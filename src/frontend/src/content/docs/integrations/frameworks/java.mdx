...
The Aspire Java hosting integration enables you to run Java applications, including Spring Boot applications, alongside your .NET projects in the Aspire app host.
...
<InstallPackage packageName="CommunityToolkit.Aspire.Hosting.Java" shortName="java" />
