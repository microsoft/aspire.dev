---
title: Orleans
description: Learn how to use the Orleans hosting integration to configure and orchestrate Orleans from your AppHost project.
---
...
<InstallPackage packageName="Aspire.Hosting.Orleans" shortName="orleans" />
