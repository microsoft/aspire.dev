...
<Aside type="note">
HTTPS is needed primarily when your Python service is exposed externally. For internal service-to-service communication within Aspire, HTTP is sufficient and simpler to configure.
</Aside>
