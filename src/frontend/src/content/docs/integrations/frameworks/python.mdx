...
Remove `CommunityToolkit.Aspire.Hosting.Python.Extensions` and install `Aspire.Hosting.Python`. Then replace Toolkit-specific helpers with the official APIs that match the process you run:
