...
As of Aspire 13, Python is a first-class workload with full support for debugging, service discovery, and deployment alongside .NET and JavaScript applications.
