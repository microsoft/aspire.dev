...
description: Learn how to use the Aspire Community Toolkit Python hosting extensions to run Python applications with Uvicorn and uv package manager.
---
...
The Aspire Community Toolkit Python hosting extensions provide additional functionality to the official [Aspire.Hosting.Python](/integrations/frameworks/python/python-host) hosting integration. This package adds support for [Uvicorn](https://www.uvicorn.org/) applications with additional configuration options and [uv](https://docs.astral.sh/uv/) package manager applications.

<Aside type="tip">

For general Python hosting capabilities, see the [Python Hosting integration](/integrations/frameworks/python/python-host) article which covers the official `Aspire.Hosting.Python` package.
...
- [Python Hosting integration](/integrations/frameworks/python/python-host)
