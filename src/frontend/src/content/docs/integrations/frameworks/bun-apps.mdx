...
The Aspire Bun hosting integration enables you to run [Bun](https://bun.sh/) applications alongside your .NET projects in the Aspire app host. Bun is a fast JavaScript runtime and toolkit.
...
<InstallPackage packageName="CommunityToolkit.Aspire.Hosting.Bun" shortName="bun" />
