...
The Aspire Go hosting integration enables you to run Go applications alongside your .NET projects in the Aspire app host.
...
<InstallPackage packageName="CommunityToolkit.Aspire.Hosting.Golang" shortName="golang" />
