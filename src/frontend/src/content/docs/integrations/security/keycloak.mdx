...
Keycloak containers can export telemetry to your <abbr title="OpenTelemetry Protocol" data-tooltip-placement="top">OTLP</abbr> collector using the `WithOtlpExporter` method:
