...
editUrl: false
hero:
  tagline: Aspire Conf <p>Thank you for joining us and celebrating the release of Aspire 13.3. Watch the replay on our <a href="https://www.youtube.com/playlist?list=PLSi5JsxQ5oNvRCeQj5v6ZYUe1gwzTSUfR">YouTube playlist</a>.</p>
  image:
    alt: Aspire logo
    file: ../../../assets/aspire-hero.png
  actions:
    - text: Get Aspire 13.3
      link: /whats-new/aspire-13-3/
