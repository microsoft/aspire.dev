...
:::tip[Using VS Code?]
Install the [Aspire VS Code extension](/get-started/aspire-vscode-extension/) after the CLI. It can run the CLI install command from the Command Palette, discover AppHosts in your workspace, and start debugging with <Kbd windows="F5" mac="F5" />.
:::
