...
Aspire provides a command-line interface (CLI) tool to help you create and manage cloud-native applications. The CLI streamlines your development workflow whether you use Visual Studio, Visual Studio Code, or work directly from the terminal.

This guide shows you how to install the Aspire CLI on your system.
...
:::note[Single command: download and install]{icon="download"}
