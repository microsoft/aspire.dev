...
1.  Run the script to install the stable release build of Aspire.
    ...
    <OsAwareTabs syncKey="terminal">
      <div slot="unix">
        ...
        ```txt title="Output" frame="terminal" data-disable-copy
        Downloading from:
      ...
      <div slot="windows">
        ...
        ```txt title="Output" frame="terminal" data-disable-copy Downloading
        from: https://aka.ms/dotnet/9/aspire/ga/daily/aspire-cli-win-x64.zip
