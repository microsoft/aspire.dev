...
<AppHostLangPivot>
  <div slot="csharp">
<ul>
  <li>Having trouble? Check out our [Troubleshooting guide](/get-started/troubleshooting/) for solutions to common problems.</li>
  <li>Prefer a GUI? The [Aspire VS Code extension](/get-started/aspire-vscode-extension/) lets you create, run, and debug Aspire apps from VS Code.</li>
</ul>
  </div>
