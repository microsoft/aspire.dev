...
1. Explore the AppHost code that orchestrates your app.
    ...
    - `WithUv` adds a Uv environment setup task: `uv sync`
    ...
    Learn more about Python hosting integration features like `AddPythonApp`, `AddPythonModule`, and virtual environment management in the [Python Hosting integration](/integrations/frameworks/python/python-host) article.
