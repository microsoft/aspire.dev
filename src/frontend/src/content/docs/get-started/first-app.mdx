---
title: Create your first Aspire app
...
To create your first Aspire application, use the Aspire CLI to generate a new solution from the `aspire-starter` template. This template includes multiple projects, including an API service, web frontend, and app host.
