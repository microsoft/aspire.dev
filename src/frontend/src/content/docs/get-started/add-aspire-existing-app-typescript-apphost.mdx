...
2. Run `aspire init` to initialize Aspire support:
   ...
   This page consistently uses `aspire init --language typescript` and `apphost.ts` in every example.
   </Aside>
...
- **JavaScript-friendly** — Works well with JavaScript and TypeScript apps plus containerized services.
