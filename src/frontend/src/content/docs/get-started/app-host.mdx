...
<LearnMore>
Prefer writing your AppHost in TypeScript? Start with [Build your first Aspire app](/get-started/first-app-typescript-apphost/).
</LearnMore>
...
To build this architecture step-by-step, see the [Build your first app](/get-started/first-app-csharp-apphost/?lang=csharp) quickstart.
...
To build this architecture step-by-step, see the [Build your first app](/get-started/first-app-csharp-apphost/?lang=python) quickstart.
