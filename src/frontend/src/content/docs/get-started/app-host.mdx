...
:::note
This three-tier architecture is just one example of how you can use Aspire. The AppHost is flexible and can model any distributed architecture, from microservices to serverless functions to multi-container apps. In works with any frontend, backend, database, or other resource—there are no limitations on the technologies you can use together.
:::
