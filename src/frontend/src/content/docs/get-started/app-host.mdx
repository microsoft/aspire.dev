...
<Aside type="tip">
The Python integration is provided by the [Aspire.Hosting.Python](https://www.nuget.org/packages/Aspire.Hosting.Python) NuGet package. Learn more in the [Python integration](/integrations/frameworks/python/) documentation.
</Aside>
...
<Aside type="tip">
The Java integration is provided by the [CommunityToolkit.Aspire.Hosting.Java](https://www.nuget.org/packages/CommunityToolkit.Aspire.Hosting.Java) NuGet package. Learn more in the [Java integration](/integrations/frameworks/java/java-get-started/) documentation.
</Aside>
...
<SimpleAppHostCode lang="python">
  <p>Uses <ApiReference name="Aspire.Hosting.PythonAppResourceBuilderExtensions.AddUvicornApp" /> with <ApiReference name="Aspire.Hosting.PythonAppResourceBuilderExtensions.WithUv" /> for ASGI apps like FastAPI.</p>
</SimpleAppHostCode>
</Pivot>
<Pivot id="nodejs">
<SimpleAppHostCode lang="nodejs">
  <p>Uses <ApiReference name="Aspire.Hosting.JavaScriptHostingExtensions.AddNodeApp" /> with <ApiReference name="Aspire.Hosting.JavaScriptHostingExtensions.WithNpm" package="Aspire.Hosting.JavaScript" /> for Node.js applications.</p>
</SimpleAppHostCode>
</Pivot>
<Pivot id="go">
...
<Aside type="tip">
  To also keep the container running between AppHost restarts (avoiding slow startup), add <ApiReference name="Aspire.Hosting.ResourceBuilderExtensions.WithPersistentLifetime" />. See [resource lifetimes](/app-host/resource-lifetimes/) for details.
</Aside>
...
Next, register the API service and wire it to the PostgreSQL resource with <ApiReference name="Aspire.Hosting.ResourceBuilderExtensions.WithReference" />:
