...
<SimpleAppHostCode lang="nodejs">
  <p>Uses <ApiReference name="Aspire.Hosting.JavaScriptHostingExtensions.AddNodeApp" /> with <ApiReference name="Aspire.Hosting.JavaScriptHostingExtensions.WithNpm" /> for Node.js applications.</p>
</SimpleAppHostCode>
</Pivot>
<Pivot id="go">
