...
For more information, see [ProjectResourceBuilderExtensions.AddProject Method](https://learn.microsoft.com/en-us/dotnet/api/aspire.hosting.projectresourcebuilderextensions.addproject?view=dotnet-aspire-13.0).
