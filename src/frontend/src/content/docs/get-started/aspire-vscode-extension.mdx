...
<p align="center"><em>The <strong>Aspire: New Aspire project</strong> command palette in VS Code, showing starter templates for Blazor, React + C#, Express + TypeScript, FastAPI + TypeScript, and an empty AppHost.</em></p>
