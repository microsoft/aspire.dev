...
Press <Kbd windows='F5' /> and the extension builds your AppHost, starts every resource, attaches the right debugger to each language — C#, TypeScript, Python, browser apps, Azure Functions — and opens the dashboard.
