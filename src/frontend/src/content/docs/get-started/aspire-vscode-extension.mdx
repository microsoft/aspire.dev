...
1. Open VS Code.
1. Open the **Extensions** view (<Kbd windows='Control+Shift+X' mac='Command+Shift+X' />).
...
1. Open an existing Aspire project in VS Code, or create one with **Aspire: New Aspire project** from the Command Palette (<Kbd windows='Control+Shift+P' mac='Command+Shift+P' />).
