...
The official Aspire extension for [Visual Studio Code](https://code.visualstudio.com/) turns VS Code into a first-class environment for building, debugging, and shipping C# and [polyglot](/get-started/glossary/#polyglot) Aspire apps.
