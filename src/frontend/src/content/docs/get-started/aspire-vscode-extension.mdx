...
| **<abbr title="Model Context Protocol" data-tooltip-placement="top">MCP</abbr>** | Let AI tools like GitHub Copilot see your running app via the Model Context Protocol |
...
| **Restore** | Run `aspire restore` to sync integration packages with `aspire.config.json` |
