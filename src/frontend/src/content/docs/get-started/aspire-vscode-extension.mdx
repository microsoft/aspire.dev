...
- **File-based C# AppHosts** — Files with the `#:sdk Aspire.AppHost.Sdk` directive at the top are standalone scripts and launch directly from their source path, not from a project file.
