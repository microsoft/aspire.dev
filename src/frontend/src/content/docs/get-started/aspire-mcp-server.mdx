...
<LearnMore>
  To set up your project for AI coding agents, see [AI coding agents](/get-started/configure-mcp/).
</LearnMore>
...
- [AI coding agents](/get-started/configure-mcp/) — set up your project for AI agents
