...
<LearnMore>
  To set up your project for AI coding agents, see [AI coding agents](/get-started/ai-coding-agents/).
</LearnMore>
...
- [AI coding agents](/get-started/ai-coding-agents/) — set up your project for AI agents
