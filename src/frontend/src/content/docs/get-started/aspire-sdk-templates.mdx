...
For more information, see [Troubleshoot untrusted localhost certificate](/get-started/troubleshooting/). For in-depth details about troubleshooting localhost certificates on Linux, see [ASP.NET Core: GitHub repository issue #32842](https://github.com/dotnet/aspnetcore/issues/32842).
