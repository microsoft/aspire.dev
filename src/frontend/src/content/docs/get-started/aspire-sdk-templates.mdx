...
For platform-specific setup, including Linux OpenSSL and browser trust, see [Trusting the development certificate](/app-host/certificate-configuration/#trusting-the-development-certificate).
