...
1. #### Install your language runtime
    ...
    Aspire's TypeScript AppHost requires a supported [Node.js](https://nodejs.org/) LTS release: **22.x or 24.x**. When you run `aspire init`, the CLI writes this engine range into the scaffolded `package.json`:
