...
<PivotSelector
    ...
    key="apphost"
    options={[
        { id: "csharp", title: "C# AppHost" },
        { id: "typescript", title: "TypeScript AppHost" },
    ]}
/>
...
1. #### Install your language runtime
    ...
    <Aside type="tip" title="Important">
    The TypeScript AppHost does not require the .NET SDK. The Aspire CLI handles everything for you.
    </Aside>
...
1. #### Install an integrated development environment (IDE)
    ...
    2. [C# extension](https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.csharp) for C# language support (C# AppHost only).
