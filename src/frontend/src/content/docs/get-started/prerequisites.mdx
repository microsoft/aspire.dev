...
1. **Install an integrated development environment (IDE)**
    ...
    - [C# extension](https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.csharp) for .NET development
    - [Aspire extension](https://marketplace.visualstudio.com/items?itemName=microsoft-aspire.aspire-vscode) for Aspire-specific features
    :::
