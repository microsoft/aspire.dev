...
<Steps>
1. **Install the .NET 8.0 or later**

    Aspire is built on .NET, a free, open-source, cross-platform framework for building modern apps and cloud services. You'll need the .NET SDK version 8.0 or later—no prior C# experience is required:
    ...
    The Aspire CLI requires the [.NET 10.0 SDK](https://dotnet.microsoft.com/download/dotnet/10.0) to be installed on your machine.
    :::
