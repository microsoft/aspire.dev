...
<span aria-hidden="true" data-funnel="existing_app_adoption" data-funnel-step="approach_selected" data-funnel-trigger="view" data-funnel-surface="existing_app_page" data-funnel-approach="ai_agent" />
...
1. Run `aspire init` in your repo root:
   ...
   ```bash title="Initialize Aspire" data-funnel="existing_app_adoption" data-funnel-step="setup_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-approach="ai_agent" data-funnel-method="aspire_cli"
   aspire init
   ```
...
<span aria-hidden="true" data-funnel="existing_app_adoption" data-funnel-step="approach_selected" data-funnel-trigger="view" data-funnel-surface="existing_app_page" data-funnel-approach="manual" />
...
1. Run `aspire init` from your repo root. Without a `.sln` present, it creates a file-based `apphost.cs`:
   ...
   ```bash title="Initialize Aspire with a file-based AppHost" data-funnel="existing_app_adoption" data-funnel-step="setup_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-approach="manual" data-funnel-method="aspire_cli"
   aspire init
   ```

2. Add hosting integrations:

   ```bash title="Add hosting integrations" data-funnel="existing_app_adoption" data-funnel-step="setup_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-approach="manual" data-funnel-method="aspire_cli"
   aspire add redis
   ```
...
1. Run `aspire init` from your solution root. It detects the `.sln` and creates a project-based AppHost automatically:
   ...
   ```bash title="Initialize Aspire in a .NET solution" data-funnel="existing_app_adoption" data-funnel-step="setup_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-approach="manual" data-funnel-method="aspire_cli"
   aspire init
   ```

2. Add project references from the AppHost to each service you want to orchestrate:

   ```bash title="Add project references" data-funnel="existing_app_adoption" data-funnel-step="setup_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-approach="manual" data-funnel-method="dotnet_cli"
...
1. Run `aspire init` from your workspace root with the TypeScript language option:
   ...
   ```bash title="Initialize Aspire with a TypeScript AppHost" data-funnel="existing_app_adoption" data-funnel-step="setup_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-approach="manual" data-funnel-method="aspire_cli"
...
```bash title="Initialize from a workspace subdirectory" data-funnel="existing_app_adoption" data-funnel-step="setup_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-approach="manual" data-funnel-method="aspire_cli"
cd apps/my-app
...
1. From the directory that contains your AppHost, run:
   ...
   ```bash title="Run your application with Aspire" data-funnel="existing_app_adoption" data-funnel-step="run_command_copied" data-funnel-trigger="copy" data-funnel-surface="existing_app_page" data-funnel-method="aspire_cli"
   aspire run
   ```
