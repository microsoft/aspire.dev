...
- Common APIs include:
  ...
  | `AddRedis()`, `AddPostgres()` | Add shared infrastructure with first-class integrations and connection wiring. |
  ...
  | `WithReference()`, `WaitFor()`, `WithHttpEndpoint()` | Wire service discovery, startup ordering, and HTTP endpoints between resources. |
...
- Common APIs include:
  ...
  | `addRedis()`, `addPostgres()` | Add shared infrastructure with first-class integrations and references. |
