...
<Aside type="caution">
Aspire uses containers for databases, caches, and other resources. Without a container runtime, these resources can't start.
</Aside>
...
<Expand summary="How to find processes using a port">
...
<Expand summary="Example: Connecting a database to your service">
...
<Expand summary="How to manually pull and verify an image">
...
<Expand summary="Example: Correct service discovery setup">
...
<LearnMore>
For a deeper understanding of how service discovery works in Aspire, see [Service discovery](/fundamentals/service-discovery/).
</LearnMore>

<LearnMore>
For more help, see [Aspire Support](/support/) or check the [GitHub Discussions](https://github.com/dotnet/aspire/discussions).
</LearnMore>
