...
1. Select the **skills and tools** to install into those locations. The flow pre-selects the Aspire workflow skills that apply to the current command; Playwright CLI and dotnet-inspect are available as opt-in tools:

   - **Aspire skill** — teaches your AI agent how to use Aspire CLI commands
   - **aspireify** — teaches your AI agent to bootstrap Aspire into existing projects
   - **aspire-deployment** — teaches your AI agent to deploy Aspire applications
