...
Examples include TypeScript, Python, Go, Java, and Rust code as used in AppHosts, generated SDKs, or related tooling.

This contrasts with some other contexts where polyglot refers to any combination of languages.
