...
description: Key terms and concepts used throughout .NET Aspire documentation, including AppHost, resources, service discovery, and orchestration terminology.
---
...
- Generates deployment manifests for production
