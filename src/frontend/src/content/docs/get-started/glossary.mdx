...
| Heterogeneous <abbr title="Directed Acyclic Graph" data-tooltip-placement="top">DAG</abbr> | <abbr title="Directed Acyclic Graph" data-tooltip-placement="top">DAG</abbr> containing varied resource types (projects, containers, cloud). |
