...
<PivotSelector
    title="Select your starter template"
    key="lang"
    marginTop="1"
    options={[
        { id: "csharp", title: "C#" },
...
1. Explore the AppHost code that orchestrates your app.
    ...
    - `AddProject` registers your API service and web front end
    ...
    - `WaitFor` ensures the API is healthy before starting the front end, preventing connection errors from race conditions
    ...
    - `WaitFor` ensures the API is healthy before starting the front end, preventing connection errors
