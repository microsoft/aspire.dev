...
> [Polyglot](/get-started/glossary/#polyglot) capability ID '{0}' is defined by multiple exports in this assembly: {1}. Use unique AspireExport IDs for overloaded or colliding members.
