...
> AspireExport Description is compatibility metadata. Use XML documentation with ATS tags such as `<ats-summary>` for generated [polyglot](/get-started/glossary/#polyglot) SDK documentation.
...
```csharp title="Integration.cs (corrected)"
...
```csharp title="Using ats-summary override"
