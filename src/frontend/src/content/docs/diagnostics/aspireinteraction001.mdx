...
title: ASPIREINTERACTION001
description: The interaction service APIs are experimental and subject to change.
---
...
| Property | Value |
|----------|-------|
| **Diagnostic ID** | ASPIREINTERACTION001 |
| **Severity** | Warning |
| **Category** | Usage |
...
- `IInteractionService.PromptAsync`
- `IInteractionService.ConfirmAsync`
- `IInteractionService.SelectAsync`
...
var result = await interactionService.PromptAsync("Enter value:", cancellationToken);
