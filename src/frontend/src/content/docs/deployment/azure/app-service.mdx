...
<LearnMore>
Start with [Deploy to Azure](/deployment/azure/) for the shared Azure deployment model and target selection.
</LearnMore>
...
For a standard App Service deployment, you only need the environment and a supported app resource. When you want to customize the generated website or deployment slot, use the App Service hosting integration guidance.
...
Aspire prompts for your Azure tenant, subscription, resource group, and any AppHost parameters it needs, then provisions and deploys the App Service resources behind the scenes.

## Monitoring and diagnostics

### Aspire Dashboard

The Azure App Service environment includes the Aspire Dashboard by default, so you can inspect logs, traces, metrics, and topology after deployment. If you don't want to deploy it, disable it on the environment:
...
<LearnMore>
For existing Application Insights resources and advanced configuration, see [Azure App Service Hosting integration](/integrations/cloud/azure/azure-app-service/azure-app-service-host/).
</LearnMore>
...
<LearnMore>
For existing plans, advanced customization, and deployment slot behavior, see [Azure App Service Hosting integration](/integrations/cloud/azure/azure-app-service/azure-app-service-host/).
</LearnMore>
...
<LearnMore>
For environment-variable validation details and advanced App Service customization, see [Azure App Service Hosting integration](/integrations/cloud/azure/azure-app-service/azure-app-service-host/).
</LearnMore>
