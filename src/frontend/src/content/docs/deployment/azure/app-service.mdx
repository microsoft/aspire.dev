...
- For local deployment, [Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli) installed and available on your `PATH`
- An active Azure account and subscription

For local deployment, authenticate with Azure CLI before deploying:
