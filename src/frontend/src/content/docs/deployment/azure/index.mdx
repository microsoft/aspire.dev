...
| [Azure Container Apps Sandboxes](/deployment/azure/sandboxes/) (experimental) | External HTTP endpoints only, authenticated with Microsoft Entra ID unless anonymous access is enabled. | Isolated, container-backed workloads that benefit from sandbox tiers and auto-suspend or auto-delete lifecycles. |
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Deploy container-backed resources to experimental sandbox groups with tiers, lifecycles, and endpoint access."
    href="/deployment/azure/sandboxes/"
  />
</CardGrid>
