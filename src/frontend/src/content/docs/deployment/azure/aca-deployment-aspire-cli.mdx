...
<Aside type="tip">
  For general information about deploying Aspire applications, see [Aspire
...
- [Azure Container Apps documentation](/integrations/cloud/azure/configure-container-apps/)
