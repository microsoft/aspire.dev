...
Azure Container Apps Sandboxes is a preview Azure service, and the `Aspire.Hosting.Azure.Sandboxes` libary is prerelease. The API surface and deployment behavior may change in future releases.
:::
