...
<TopicHero
  ...
  accent="orange"
  primaryCta={{ label: 'Deploy your first app', href: '/get-started/deploy-first-app/' }}
  secondaryCta={{ label: 'Read deployment overview', href: '/deployment/overview/' }}
/>
