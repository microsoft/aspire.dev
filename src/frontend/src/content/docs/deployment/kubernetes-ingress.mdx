...
<Aside type="note">
  This inheritance behavior applies from Aspire 13.6 onward. In earlier
  versions, hostless paths and routes were generated as catch-all rules even
  when `WithHostname(...)` was set on the Ingress or Gateway.
</Aside>
