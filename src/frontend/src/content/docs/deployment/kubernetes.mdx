...
To configure your AppHost for Kubernetes, add a Kubernetes environment:
...
```plaintext title="Generated Helm chart structure"
k8s-artifacts/
...
builder.AddContainer("service", "nginx")
    ...
    {
        // Customize deployment-level settings
...
const api = await builder.addProject("api", "../MyApi/MyApi.csproj");
await api.publishAsKubernetesService((resource) => {
