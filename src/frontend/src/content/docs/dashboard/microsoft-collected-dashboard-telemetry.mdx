...
| 9.3 | Dashboard-related unhandled exceptions. | Doesn't include browser-storage read failures caused by the browser tab disconnecting while the dashboard restores saved navigation state. |
