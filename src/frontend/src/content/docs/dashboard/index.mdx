...
import projectsImageLight from '@assets/dashboard/explore/resources-filtered-containers-light.png';
import tracesImage from '@assets/dashboard/explore/trace-span-details.png';
import tracesImageLight from '@assets/dashboard/explore/trace-span-details-light.png';
...
import structuredLogsImageLight from '@assets/dashboard/explore/structured-logs-errors-view-light.png';
...
<ImageShowcase
  ...
  darkImage={projectsImage}
  lightImage={projectsImageLight}
...
<ImageShowcase
  ...
  darkImage={tracesImage}
  lightImage={tracesImageLight}
...
<ImageShowcase
  ...
  darkImage={structuredLogsImage}
  lightImage={structuredLogsImageLight}
