...
The OTLP endpoints can be secured with API key or client certificate authentication. For configuration details, see [OTLP authentication](/dashboard/configuration/#otlp-authentication).
