...
:::tip[Run without installing]
If you have [Node.js](https://nodejs.org/) 20 or later, you can launch the dashboard without installing the CLI by running it through [npx](https://docs.npmjs.com/cli/commands/npx):
