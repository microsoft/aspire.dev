...
If your [Node.js](https://nodejs.org/) version meets the [`@microsoft/aspire-cli` npm package requirements](https://www.npmjs.com/package/@microsoft/aspire-cli), you can launch the dashboard without installing the CLI by running it through [npx](https://docs.npmjs.com/cli/commands/npx):
