...
For more details, see the [`aspire otel logs`](/reference/cli/commands/aspire-otel-logs/), [`aspire otel trace`](/reference/cli/commands/aspire-otel-trace/), and [`aspire otel spans`](/reference/cli/commands/aspire-otel-spans/) command references.
