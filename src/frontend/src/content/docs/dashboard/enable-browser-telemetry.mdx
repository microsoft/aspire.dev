...
<Aside type="note">
Replace `https://localhost:21036` with the actual URL of your dashboard's HTTP OTLP endpoint. If your app is launched by the AppHost, you can access this value from the `OTEL_EXPORTER_OTLP_ENDPOINT` environment variable.
</Aside>
