...
Starting with Aspire 13.1, you can configure the MCP server automatically using the `aspire agent init` command. See [Configure MCP](/get-started/ai-coding-agents/) for the recommended approach.
</Aside>
