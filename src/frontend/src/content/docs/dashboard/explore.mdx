...
- Operation performed, in this case an:
  ...
  ```http title="images collection request"
...
<Image src={dashboardRunSelector} alt="Aspire dashboard header showing the Live run selector button." />
...
<Image src={dashboardRunSelectorExpanded} alt="Expanded Aspire dashboard run selector showing the live run and a pinned historical run." />
...
<Image src={notificationCenterBell} alt="Aspire dashboard header showing the notification center bell icon with an unread count badge." />
...
<Image src={notificationCenterOpen} alt="Aspire dashboard Notifications dialog showing a list of command notifications with timestamps." />
