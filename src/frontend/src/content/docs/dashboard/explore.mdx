...
While a page is paused, a **Capture paused** banner remains visible in the page footer as a reminder that new telemetry isn't being displayed. This banner is consistent across the **Console logs**, **Structured logs**, **Traces**, and **Metrics** pages, and it's removed automatically as soon as you resume capture.
