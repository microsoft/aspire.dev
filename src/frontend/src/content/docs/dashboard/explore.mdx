...
- [Azure OpenAI integration](https://learn.microsoft.com/dotnet/aspire/azureai/azureai-openai-integration/).
- [Azure AI Inference integration](https://learn.microsoft.com/dotnet/aspire/azureai/azureai-inference-integration/).
- [Azure AI Foundry integration](https://learn.microsoft.com/dotnet/aspire/azureai/azureai-foundry-integration/).
- [Aspire AI integrations compatibility matrix](https://learn.microsoft.com/dotnet/aspire/azureai/ai-integrations-compatibility-matrix/).
