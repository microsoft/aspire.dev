...
- [Azure OpenAI integration](/integrations/cloud/azure/azure-openai/azure-openai-client/).
- [Azure AI Inference integration](/integrations/cloud/azure/azure-ai-inference/azure-ai-inference-client/#configuring-sensitive-data-in-telemetry).
...
- **Traces**: <abbr title="OpenTelemetry Protocol" data-tooltip-placement="top">OTLP</abbr> JSON files with distributed trace spans.
- **Metrics**: <abbr title="OpenTelemetry Protocol" data-tooltip-placement="top">OTLP</abbr> JSON files with metric data points.
...
Select **Import logs and telemetry** to import previously exported data. The dashboard accepts `.zip` files (exported from the dashboard) and individual `.json` files containing <abbr title="OpenTelemetry Protocol" data-tooltip-placement="top">OTLP</abbr> telemetry data. The maximum file size is 100 MB.
