...
Aspire persists telemetry data for each run, allowing you to review and analyze historical data. The run selector in the dashboard header allows you to switch between different runs.

<Image src={dashboardRunSelector} alt="Aspire dashboard header showing the Live run selector button." />

Open the selector to browse previous runs for the Aspire app:
