...
Resources configured with `WithTerminal` also provide an interactive **Terminal** view. For resource terminals, the AppHost terminal dock, detached windows, and keyboard controls, see [Dashboard terminals](/dashboard/terminals/).
