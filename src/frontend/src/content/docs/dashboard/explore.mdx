...
When you open the Console logs page, you must select a source in the **Select a resource** drop-down list. If the selected resource has a long name, it's truncated with an ellipsis in the drop-down button while the full name remains visible in the opened list.
