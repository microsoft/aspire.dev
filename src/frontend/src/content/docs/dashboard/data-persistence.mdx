...
The run selector includes a **Learn about runs** option below the run list. It summarizes live, historical, and pinned runs and opens this page in a new window.
