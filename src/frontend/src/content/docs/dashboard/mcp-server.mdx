...
- If you already launch your Aspire app with [the `http` launch profile](/fundamentals/launch-profiles/) then your app isn't using HTTPS and you don't need to do anything.
