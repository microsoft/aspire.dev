...
Starting with Aspire 13.1, you can configure the MCP server automatically using the `aspire mcp init` command. See [Agentic development](/agentic/overview/) for the recommended approach.
</Aside>
...
1. Run the [`aspire mcp init`](/reference/cli/commands/aspire-mcp-init/) command:
