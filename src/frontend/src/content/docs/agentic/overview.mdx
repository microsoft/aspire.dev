...
<AsciinemaPlayer src="/casts/mcp-init.cast" poster="npt:0:03" />
...
The Aspire MCP server can work with other agentic coding environments that support the Model Context Protocol. While `aspire mcp init` automatically configures the listed AI assistants, you can manually configure other MCP-compatible tools by following their documentation and using the `aspire mcp start` command.
...
<Tabs>
  ...
  <TabItem label="Claude Code" id="demo-claude">
    <AsciinemaPlayer src="/casts/mcp-claudecode-cli.cast" poster="npt:0:03" />
  </TabItem>
  <TabItem label="Copilot CLI" id="demo-copilot">
    <AsciinemaPlayer src="/casts/mcp-copilot-cli.cast" poster="npt:0:03" />
  </TabItem>
  <TabItem label="OpenCode" id="demo-opencode">
    <AsciinemaPlayer src="/casts/mcp-opencode-cli.cast" poster="npt:0:03" />
  </TabItem>
</Tabs>
