...
```go title="Go — main.go"
// Go apps connect directly using database drivers.
// Health check behavior is controlled by your
// application code, not an Aspire integration.
```
...
# Python apps connect directly using database drivers.
# Health check behavior is controlled by your
# application code, not an Aspire integration.
```
...
// TypeScript apps connect directly using database drivers.
// Health check behavior is controlled by your
// application code, not an Aspire integration.
```
