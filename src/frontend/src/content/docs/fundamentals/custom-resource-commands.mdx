...
| `Arguments` | `IList<string>` | Argument list passed to the process. Each entry is a separate argument — no shell quoting needed. |
| `EnvironmentVariables` | `IDictionary<string, string>` | Environment variables to set for the child process. |
