...
<Aside type="caution">
.NET hot reload support within Aspire has known limitations and open issues. Results may vary depending on the type of project and the changes being made. If you experience problems, the workarounds in this guide (persistent containers, minimal service sets) are more reliable for improving inner-loop speed.
</Aside>
