...
For more information, see [Launch profiles](/integrations/dotnet/launch-profiles/).
...
**Symptom**: Certificate validation fails in development

**Solution**: Trust the ASP.NET Core development certificate:
