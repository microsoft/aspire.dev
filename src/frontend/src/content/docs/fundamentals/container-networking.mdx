...
var executable = builder.AddExecutable("executable", "command", "")
    .WithHttpEndpoint(targetPort: 1234, port: 5678, name: "http");

var containerEndpoint = executable.GetEndpoint(
    "http",
    KnownNetworkIdentifiers.DefaultAspireContainerNetwork);

executable.WithEnvironment("CONTAINER_URL", containerEndpoint);
```
