...
You want to distribute your Blazor app as a Docker container image via a GitHub Container Registry. You will need the [Aspire.Hosting.Docker](/integrations/compute/docker/) and [Aspire.Hosting.SqlServer](/integrations/databases/sql-server/sql-server-get-started/) integrations. 
