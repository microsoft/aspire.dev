...
If you close the **Unresolved parameters** notification instead of resolving it, Aspire no longer redisplays it automatically. The parameters remain unresolved, and you can still set their values later from the corresponding resource commands in the dashboard.
