...
<Image src={customHttpCommandHighlighted} alt="Aspire dashboard: Resources page showing a highlighted custom HTTP command." />
...
<Image src={customHttpCommand} alt="Aspire dashboard: Resources page showing a custom HTTP command in the ellipsis menu." />
...
<Image src={customHttpCommandStarting} alt="Aspire dashboard: Toast notification showing the custom HTTP command is starting." />
...
<Image src={customHttpCommandSucceeded} alt="Aspire dashboard: Toast notification showing the custom HTTP command succeeded." />
