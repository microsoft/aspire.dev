...
<LearnMore>
Prefer writing your AppHost in a language other than C#? See [Polyglot AppHost](/app-host/polyglot-apphost/) to write your AppHost in TypeScript, Python, Go, Rust, or Java.
</LearnMore>
