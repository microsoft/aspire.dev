---
title: Examples
seoTitle: Aspire Resource Examples and Custom Resource Patterns
description: Explore complete, runnable examples demonstrating key concepts in Aspire, including custom resources, lifecycle events, and hierarchical resource structures.
next: false
---
