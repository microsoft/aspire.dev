...
```csharp title="RedisResourceExtensions.cs"
...
```csharp title="TalkingClockResource.cs"
...
```csharp title="TalkingClockEventingSubscriber.cs"
...
```csharp title="TalkingClockExtensions.cs"
