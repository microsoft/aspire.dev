...
/**
 * Social-card fallback for pages without a frontmatter `description`.
 * Starlight owns the standard description meta tag; this fallback only
 * applies to Open Graph and Twitter previews.
 */
