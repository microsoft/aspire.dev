...
export interface APIGatewayEmulatorResource extends ExecutableResource, ContainerResource, IComputeResource, IResource, IResourceWithArgs, IResourceWithEndpoints, IResourceWithEnvironment, IResourceWithProbes, IResourceWithWaitSupport {
...
export interface LambdaEmulatorResource extends ExecutableResource, ContainerResource, IComputeResource, IResource, IResourceWithArgs, IResourceWithEndpoints, IResourceWithEnvironment, IResourceWithProbes, IResourceWithWaitSupport {
}
...
export interface LambdaProjectResource extends ProjectResource, ContainerResource, IComputeResource, IContainerFilesDestinationResource, IResource, IResourceWithArgs, IResourceWithEndpoints, IResourceWithEnvironment, IResourceWithProbes, IResourceWithWaitSupport, IResourceWithServiceDiscovery {

  withDynamoDBStreamsEventSource(tableName: string, options?: { options?: DynamoDBStreamsEventSourceOptions }): this;

  withDynamoDBStreamsEventSource(tableName: string, options?: DynamoDBStreamsEventSourceOptions): this;

  withSQSEventSource(queueUrl: string, options?: { options?: SQSEventSourceOptions }): this;
...
export interface IDistributedApplicationBuilder {
  ...
  addAWSAPIGatewayEmulator(name: string, apiGatewayType: APIGatewayType, options?: { options?: APIGatewayEmulatorOptions }): APIGatewayEmulatorResource;
  ...
  addAWSDynamoDBLocal(name: string, options?: { options?: DynamoDBLocalOptions }): DynamoDBLocalResource;

  addAWSDynamoDBLocal(name: string, options?: DynamoDBLocalOptions): DynamoDBLocalResource;

  addAWSLambdaFunction(name: string, projectPath: string, lambdaHandler: string, options?: { options?: LambdaFunctionPolyglotOptions }): LambdaProjectResource;
  ...
  addAWSLambdaServiceEmulator(options?: { options?: LambdaEmulatorOptions }): LambdaEmulatorResource;
