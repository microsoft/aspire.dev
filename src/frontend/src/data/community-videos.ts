...
export const aspireifridays: CommunityVideo[] = [
  {
...
export const dotnetConf2025: CommunityVideo[] = [
  {
    href: 'https://www.youtube.com/watch?v=FcAi-kqo3ps',
    title: 'Taking .NET out of Aspire',
    description:
      'Learn how to orchestrate Python and Node.js apps with Aspire.',
    tags: ['Official', '.NET Conf 2025', 'Multi-language'],
  },
  {
...
export const communityVideos: CommunityVideo[] = [
  {
    ...
    description:
      'Nick Chapsas shows you every Aspire 9 features and explain why I finally think that it is production ready and that everyone should be using it.',
    tags: ['Community', '9.0'],
  },
  {
    ...
    description:
      'In this video, Milan Jovanović demonstrates how to upgrade an existing Aspire 8 application to the newly released Aspire 9.2',
...
export const allCommunityVideos: CommunityVideo[] = [
  ...aspireifridays,
  ...dotnetConf2025,
  ...communityVideos,
];
