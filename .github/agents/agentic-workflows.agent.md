...
> [!IMPORTANT]
> For architecture/pattern-selection requests, load `https://github.com/github/gh-aw/blob/v0.81.6/.github/aw/patterns.md` first.
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.81.6/.github/aw/asciicharts.md
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.81.6/.github/aw/cli-commands.md
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.81.6/.github/aw/token-optimization.md
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.81.6/.github/aw/patterns.md
...
- **CLI commands reference**: For a complete guide on all `gh aw` commands and their MCP tool equivalents (for restricted environments), see https://github.com/github/gh-aw/blob/v0.81.6/.github/aw/cli-commands.md
